...
const About1 = ({img1,img2,img3,expNumber,expYers,expTitle,number,subTitle,Title,Content,feature1,feature2,listItem,avatar,name,designation}) => {
    return (
               ...
               <div className="cs_about_text">
                 ...
                 {listItem?.map((item, index) => (
                   <li key={index}>
                    ...
                    <i className="bi bi-check-lg"></i></span>
                     <span>{item}</span>
                   </li>
                    ))}
                 </ul>
