...
const LazyImage = memo(({ src, alt, className, width, height, eager = false }) => {
          ...
          <div className="col-xl-6">
            <div className="cs_about_text">
              ...
              <div className="cs_features_list cs_mb_32">
                <IconBox icon="routinemaintenance" title="Routine Maintenance" />
                <IconBox icon="fastefficientrepair" title="Fast Efficient Repair Service" />
              </div>
