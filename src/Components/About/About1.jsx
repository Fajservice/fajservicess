            ...
            <div className="cs_about_thumbnail_wrapper position-relative">
              ...
              <div className="cs_esperience_text position-absolute" style={{ minHeight: '200px' }}>
                <h2 className="cs_experience_title mb-0">
                  <span className="cs_fs_52 d-block">{expNumber}</span>
                  <span className="cs_fs_20 d-block">{expYers}</span>
                  <span className="cs_fs_36 d-block">{expTitle}</span>
                  <span className="cs_fs_50 d-block">{expTitleYear}</span>
                </h2>
          ...
          <div className="col-xl-6">
            <div className="cs_about_text">
              <div className="cs_section_heading cs_style_1 cs_mb_20">
                ...
                <h2 className="cs_section_title cs_fs_36 mb-0 wow fadeInUp">{Title}</h2>
              </div>
              ...
              <ul className="cs_list cs_style_1 cs_fs_16 cs_heading_color cs_heading_font cs_mb_38 p-0">
                {/* Add placeholder if listItem is empty */}
                {listItem?.length ? (
                  ...
                  <li style={{ visibility: 'hidden', height: '28px' }}>Loading...</li>
                )}
              </ul>
