...
const About1 = ({ img1, img2, img3, telLink, number, subTitle, Title, Content, listItem }) => {
        ...
        <div className="row cs_gap_y_40 align-items-center">
          <div className="col-xl-6">
            <div className="cs_about_thumbnail_wrapper position-relative">
              <div className="cs_about_thumbnail"><img src={img1} alt="About Image"/></div>
              <div className="cs_about_thumbnail mt-4"><img src={img2} alt="About Image" /></div>
              <div className="cs_about_thumbnail"><img src={img3} alt="About Image" /></div>
          ...
          <div className="col-xl-6">
            <div className="cs_about_text">
              <div className="cs_section_heading cs_style_1 cs_mb_20">
                ...
                <h2 className="cs_section_title cs_fs_50 mb-0 wow fadeInUp">Speedy Services Quality Results</h2>
              </div>
