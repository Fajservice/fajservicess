...
// Memoized IconBox component with lazy image loading
...
// Circular text SVG - only render when in view
const CircularTextSvg = memo(() => (
  <svg width="173" height="173" viewBox="0 0 173 173" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    {/* Rest of circular text paths - keeping shortened for readability */}
  </svg>
));
