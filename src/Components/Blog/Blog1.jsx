          ...
          {data.map((item, i) => (
            <div key={i} className="col-lg-4">
              <div className="cs_post cs_style_1 cs_type_1">
                <Link to={`/blog/blog-details/${item.slug}`} className="cs_post_thumbnail cs_mb_16 position-relative">
                ...
                <div className="cs_post_content_wrapper">
                  <div className="cs_post_content">
                    ...
                    <h3 className="cs_fs_20 cs_semibold cs_mb_5">
                      <Link to={`/blog/blog-details/${item.slug}`}>{item.title}</Link>
                    </h3>
                    <p className="cs_mb_15">{item.desc}</p>
                    <Link to={`/blog/blog-details/${item.slug}`} className="cs_text_btn cs_style_1 cs_white_bg cs_accent_color">
