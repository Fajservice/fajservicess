    ...
    return (
        <section className="section cs_py_30 bg-dark-blue text-light">
            <div className="container text-center">
                <h3 className="cs_fs_30 text-light mb-2">UAE: 7 Tips to Reduce AC Bills This Summer</h3>
                <p className="mb-5">Learn easy and proven ways to save energy with your AC. Find tips to cut the cost and stay cool all summers!</p>
                <a
