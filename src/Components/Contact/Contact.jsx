              ...
              <div class="cs_contact_info_wrapper position-relative">
                <div class="cs_contact_info cs_white_bg wow fadeInDown">
                  <div class="cs_accent_bg cs_line_shape cs_mb_32"></div>
                    <h3 class="cs_contact_info_title cs_fs_30 cs_mb_12">{Title}</h3>
                    <p class="cs_mb_25">{subTitle}</p>
                  ...
                  <div class="cs_client_info_wapper cs_white_bg">
                    <h3 class="cs_fs_30 cs_accent_color">{clientNumber}</h3>
                    <p class="cs_fs_14 mb-0">{client}</p>
                  </div>
                </div>
            ...
            <div className="col-lg-6">
              <div className="cs_section_heading cs_style_1 cs_mb_45">
                <h3 className="cs_section_subtitle cs_fs_18 cs_accent_color cs_semibold text-uppercase cs_mb_12">
                  ...
                  {subtitle2}</h3>
                <h2 class="cs_section_title cs_fs_50 mb-0 wow flipInX">{title2}</h2>
              </div>
              <Form1></Form1>
            </div>
          </div>
