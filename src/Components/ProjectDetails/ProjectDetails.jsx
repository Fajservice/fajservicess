    ...
    return (
        ...
        <div className="container">
          <div className="cs_portfolio_details">
            <img src={`${import.meta.env.BASE_URL}/img/portfolio_banner.jpg`} alt="Portfolio Banner" />
              ...
              <div className="col-xl-8 col-lg-7">
                ...
                <div className="row cs_row_gap_30">
                  <div className="col-md-6">
                    <img src={`${import.meta.env.BASE_URL}/img/portfolio_img_10.jpg`} alt="Portfolio Image" />
                  </div>
                  <div className="col-md-6">
                    <img src={`${import.meta.env.BASE_URL}/img/portfolio_img_11.jpg`} alt="Portfolio Image" />
                  </div>
                </div>
