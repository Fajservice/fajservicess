...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/ColemenAcRepairfaq.json';
...
import testimonial_data_Coleman from '../../../../Data/AcData/AcTestimonial/ColemenAcServiceTestimonials.json';
...
const ColemenAcRepair = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  // For SEO
  const metatitle = String(titleSeo || "Coleman Ac Repair in Dubai - Air Conditioner Maintenance");
  ...
  const metaURL = String(URL || "https://www.fajservices.com/coleman-ac-repair-in-dubai-coleman-ac-maintenance-in-dubai-coleman-ac-fix-in-dubai-coleman-ac-service-in-dubai-coleman-air-condition-repair-in-dubai-coleman-air-condition-maintenance-in-dubai-coleman/").replace(/\/?$/, '/').replace(/\/?$/, '/');
      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Coleman Air Conditioner Maintenance and Servicing </h3>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_30">Why is Coleman AC Maintenance Service Important in Dubai?</h3>
            <p className="mb-0">
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">Common Coleman AC Problems That May Require Maintenance</h3>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h3 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR COLEMAN AIR CONDITIONER SYSTEMS</h3>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-10 text-center">
                <h3 className="cs_fs_30 text-light">We specialise in coleman air conditioning services for the following types </h3>
