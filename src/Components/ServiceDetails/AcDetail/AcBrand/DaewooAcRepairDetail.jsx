...
import testimonial_data_Daewoo from '../../../../Data/AcData/AcTestimonial/DaewooAcServiceTestimonials.json';
...
const DaewooAcRepair = ({ subtitle, title, bgImg }) => { // For SEO
  const titleSeo = "Daewoo AC Repair in Dubai - AC Maintenance and Service";
  const description = "Are You Looking Best Daewoo AC Repair in Dubai? Call 043300002 get sameday split, central Air Conditioner maintenance, cleaning service near you Dubai";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/daewoo-ac-repair-in-dubai-daewoo-ac-maintenance-in-dubai-daewoo-ac-fix-in-dubai-daewoo-ac-service-in-dubai-daewoo-air-condition-repair-in-dubai-daewoo-air-condition-maintenance-in-dubai-daewoo-air-con/";
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Beat the heat this summer with Expert Daewoo AC repair and service in Dubai!</h1>
            <p>Ensuring year-round comfort requires effective management of challenges such as summer humidity, warm nights, and indoor allergens.
              <br />Since its founding in 2010, <a href="https://www.fajservices.ae/">F A J Technical Services L.L.C</a> has been a trusted provider of Daewoo air conditioner solutions in Dubai and Sharjah. Our skilled team offers a range of Daewoo AC repair, cleaning services, maintenance, and installation for both residential and commercial units. We are committed to optimising the performance of your air conditioning system to enhance indoor comfort.
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  If you're in Dubai and need Daewoo air conditioner repair, FAJ is here for you!
                  Our expert team ensures your AC systems run smoothly in Dubai and Sharjah, providing reliable solutions for optimal indoor comfort year-round. Enjoy a cool, refreshing environment with our help!
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/ac amc.avif`} alt="Daewoo Airconditioner Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">Common Daewoo AC Problems That May Require Maintenance</h3>
            <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">
                ...
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      <a href="https://www.youtube.com/watch?v=qnByeIsc3lY"><b>Reduced airflow</b></a> from a Daewoo air conditioner may indicate a clogged filter or faulty fan, which should be fixed for efficient cooling.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      If your Daewoo AC is blowing warm air, it may be experiencing issues with the compressor, refrigerant levels, or ductwork.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Unusual sounds like grinding, squeaking, or banging from your Daewoo AC may indicate mechanical issues that require attention.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      A Daewoo air conditioner that does not reduce humidity may have cooling capacity issues or may not be operating properly.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Water pooling around the Daewoo AC or dripping from the vents may indicate a blocked drain or frozen coils.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">High energy bills without increased usage may indicate inefficiencies in Daewoo air conditioning due to dirty filters or duct leaks.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h3 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR Daewoo AIR CONDITIONER SYSTEMS</h3>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                ...
                <ul className="cs_list cs_style_ cs_fs_16 cs_mp_ mb-0">
                  <li> <strong> Daewoo AC Installation: </strong> The professional installation of various Daewoo air conditioning systems ensures optimal performance. </li>
                  <li> <strong> Daewoo AC Inspection: </strong> We offer accurate fault diagnosis to pinpoint system issues, along with comprehensive quotes and eligibility assessments to address your concerns. </li>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-10 text-center">
                <h3 className="cs_fs_30 text-light">Benefits Of Regular Daewoo AC Service and Maintenance in Dubai </h3>
                ...
                <div className="row mt-4 gx-4 gy-4">
                  ...
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column align-items-center px-2">
                      ...
                      <p className="small">
                        Our team provides vital feedback on your Daewoo AC's health and any needed repairs.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>With <a href="/ac-annual-maintenance-contract/">annual maintenance contract</a>, you get a full year of service, ensuring your Daewoo AC runs smoothly and providing peace of mind.
                    </p>
                  </div>
                </div>
                ...
                <div className="uspitem mb-0">
                  ...
                  <div className="usptext">
                    ...
                    <p>Choose a day and time for your Daewoo AC repair in Dubai or Sharjah. With a 3-4 hour window for when our technician will arrive.
                    </p>
                  </div>
                </div>
              ...
              <div className="uspcol col-3">
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>We are experts in Daewoo AC repair. This is why most major brands trust us to handle their service and maintenance needs.</p>
                  </div>
                </div>
                <div className="uspitem">
                  <div className="uspicon">
        ...
        <section className="section cs_py_30 bg-light-gray ">
          <div className="container">
            ...
            <h3>We specialise in Daewoo air conditioning services for the following</h3>
            <div className="row">
