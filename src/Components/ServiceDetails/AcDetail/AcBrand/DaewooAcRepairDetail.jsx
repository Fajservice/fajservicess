...
const DaewooAcRepair = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metadescription = String(description || "Are you looking for professional Daewoo split AC repair in Dubai? FAJ offers Daewoo window AC maintenance and cleaning services in Sharjah near you");
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Daewoo AC Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
    ...
    const fetchData = async () => {
      try {
        const [faqsResponse, testimonialsResponse] = await Promise.all([
          fetch(`${import.meta.env.BASE_URL}data/AcData/AcFaqs/AcBrand/DaewooAcRepairfaq.json`),
          fetch(`${import.meta.env.BASE_URL}data/AcData/AcTestimonial/DaewooAcServiceTestimonials.json`)
        ]);
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Cost Effective Daewoo AC Repair and Cleaning Services in Dubai, UAE</h1>
          ...
          <div className="container">
            <div className="row gx-md-5 align-items-center expert_section_wrapper">
              <div className="col-md-6">
                ...
                <h2 className="cs_fs_24 mb-1 pt-1 mt-0 text-align-left">Top Common Signs That You Need Daewoo AC Maintenance</h2>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('ac amc')} alt="Daewoo Airconditioner Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h2 className="text-center">Common Daewoo AC Problems That May Require Maintenance</h2>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Daewoo AC SYSTEMS</h2>
            ...
            <div className="row align-items-center">
              <div className="col-xl-6">
                <iframe
                  ...
                  width="100%"
                  height="350"
                  src="https://www.youtube.com/embed/prUR0-lZlzg"
        ...
        {/*  Benefits */}
        <AcBrandBenifit brandName="Daewoo AC"/>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>With <a href="/services/air-conditioning-repair/ac-annual-maintenance-contract/">annual maintenance contract</a>, you get a full year of service, ensuring your Daewoo AC runs smoothly and providing peace of mind.
                    </p>
                  </div>
                </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_24 text-align-left">We specialise in Daewoo air conditioning services for the following</h3>
            <div className="row">
              <div className="col-12">
                ...
                <p className="mb-0"> <strong>  Extended Lifespan: </strong> Regular <a href="/services/air-conditioning-repair/ac-service/">AC maintenance</a> prevents wear and tear, prolonging the life of your AC and minimising costly repairs. </p>
