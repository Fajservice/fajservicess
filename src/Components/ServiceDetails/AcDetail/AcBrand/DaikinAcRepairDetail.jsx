...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/DaikinAcRepairfaq.json';
...
import testimonial_data_Daikin from '../../../../Data/AcData/AcTestimonial/DaikinAcServiceTestimonials.json';
...
const DaikinAcRepair = ({ subtitle, title, bgImg }) => {
  ...
  const Keyword = "";
  const URL = "https://www.fajservices.com/daikin-ac-repair-in-dubai-daikin-ac-maintenance-in-dubai-daikin-ac-fix-in-dubai-daikin-ac-service-in-dubai-daikin-air-condition-repair-in-dubai-daikin-air-condition-maintenance-in-dubai-daikin-air-con/";
            ...
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  ...
                  We are the experts in Daikin <a href="/ac-repair-dubai/">AC repair</a>, service, and maintenance across Dubai and Sharjah.
                ...
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      If you notice reduced airflow from your vents, it may indicate an issue with your Daikin AC system, such as a clogged filter or a malfunctioning fan.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="row mt-4 gx-4 gy-4">
                  ...
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column align-items-center px-2">
                      ...
                      <p className="small">
                        Our team provides vital feedback on your Daikin AC's health and any needed repairs.
                      </p>
                    </div>
                  </div>
                </div>
