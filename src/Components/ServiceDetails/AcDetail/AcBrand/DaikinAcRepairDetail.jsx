...
import testimonial_data from '../../../../Data/AcData/AcTestimonial/DaikinAcServiceTestimonials.json';
...
const DaikinAcRepair = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metaImage = String(Image || "https://www.fajservices.ae/img/daikin-ac-repair.avif");
  ...
  return (
    <>
      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h2 className="cs_fs_24 mb-1" >Daikin ac Maintenance and Servicing</h2>
        ...
        <section className="section cs_py_30 ">
          <div className="container">
            <h2 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR DAIKIN AC SYSTEMS</h2>
