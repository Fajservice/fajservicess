...
const DaikoolAcRepair = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
      <HelmetProvider>
        <title>Daikool AC Repair in Dubai - Air Conditioner Maintenance</title>
        <meta name="description" content="When it comes to Daikool AC Repair in Dubai Call us at 043300002, Get Best Air Conditioning (AC) Maintenance & Service near by Your Location."/>
      </HelmetProvider>
