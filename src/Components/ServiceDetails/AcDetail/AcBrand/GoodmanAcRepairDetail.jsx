...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/GoodmanAcRepairfaq.json';
...
import testimonial_data_GoodmanAc from '../../../../Data/AcData/AcTestimonial/GoodmanAcServiceTestimonials.json';
import parse from 'html-react-parser';
import Slider from "react-slick";
import HeaderForm from "../../../Headeform/HeaderForm";


const GoodmanAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Goodman Ac Repair Dubai - Air Conditioning Cleaning Service";
  const description = "Looking on Goodman Ac Repair in Dubai Call: 0433000002 for central, HVAC, split air conditioner Services in your location & ac maintenance";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/goodman-ac-repair-in-dubai-goodman-ac-maintenance-in-dubai-goodman-ac-fix-in-dubai-goodman-ac-service-in-dubai-goodman-air-condition-repair-in-dubai-goodman-air-condition-maintenance-in-dubai-goodman/";
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Goodman AC Maintenance Services in Dubai​</h1>
            <p><a href="https://maps.app.goo.gl/FrdktEqUSR6cgX876"><b>F A J Technical Services L.L.C.</b></a> is your top choice for AC service in Dubai. With 15 years of experience, we are a trusted provider for AC repair and maintenance across all areas of the city.
              <br />
              Our <a href="https://www.facebook.com/ACRepairUAE"><b>skilled AC technicians</b></a> can handle all types and models of Goodman air conditioning units, ensuring your home or business stays cool and comfortable.</p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best Goodman AC Repair in Dubai</h3>
                <p className="mb-2">When it comes to Goodman <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                <p>We specialize in Goodman air conditioner (AC) repair, service, and maintenance in Dubai. The FAJ team is dedicated to ensuring a comfortable temperature all year round.</p>
              ...
              <div className="col-md-6">
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Goodman Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why Goodman AC Maintenance Service is Essential in Dubai?</h3>
            <div className="row align-items-center">
              <div className="col-md-6">
                <ul className="mb-0">
                  <li><strong>Extreme Weather Conditions:</strong> Dubai's climate is characterised by high temperatures, especially in the summer months. <br />Regular maintenance ensures that Goodman AC operates efficiently, providing reliable cooling when it is needed the most.</li>
                  <li><strong>Energy Efficiency:</strong> Proper Goodman AC maintenance checks can help identify issues that reduce the efficiency of AC units. By addressing these problems, homeowners can lower their energy bills and minimise environmental impact.</li>
              ...
              <div className="col-md-6">
                ...
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/fujitsu-ac-service.avif`} alt="Goodman Ac Repair" />
              </div>
            </div>
            <p>In the UAE, where heat makes AC vital, investing in expert repair like Goodman is essential for safety, efficiency, and peace of mind.</p>
          </div>
        </section>
...
{/* testimobial section */}
        <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}${bgImg})` }}>
          <div className="cs_height_80 cs_height_Goodman_80"></div>
          <div className="container">
            ...
            <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              ...
              <div className="cs_slider_wrapper">
                <Slider {...settings}>
                  {testimonial_data_GoodmanAc.map((item, index) => (
