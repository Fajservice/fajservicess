...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/GreeAcRepairfaq.json';
  ...
  return (
    <>
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            ...
            <p>F A J Technical Services L.L.C is your top choice for AC service in Dubai. With 15 years of experience, we are a trusted provider for AC repair and maintenance across all areas of the city.
              <br />
              Our skilled AC technicians can handle all types and models of Gree air conditioning units, ensuring your home or business stays cool and comfortable.</p>
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best Gree AC Repair in Dubai</h3>
                        <p className="mb-2">When it comes to Gree <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                        <p>We specialize in Gree air conditioner (AC) repair, service, and maintenance in Dubai. The FAJ team is dedicated to ensuring a comfortable temperature all year round.</p>
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Gree Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why Gree AC Maintenance Service is Essential in Dubai?</h3>
            <div className="row align-items-center">
            <div className="col-md-6">
                <ul className="mb-0">
                <li>In Dubai, where the heat can be extreme, maintaining your Gree air conditioning units is crucial for both comfort and efficiency.</li>
                <li>Regular maintenance and servicing of Gree VRF AC systems are essential to prevent unexpected breakdowns, lower energy costs, and extend the lifespan of your equipment. By opting for professional Gree AC repair and cleaning services, you invest in a cooler and more comfortable environment, whether at home or in the office—making it a wise choice for anyone living in Dubai.</li>
                <li>Don’t wait for issues to surface; stay proactive with dependable Gree maintenance services for your air conditioning units.</li>
                <li>Keeping up with routine maintenance is vital, especially given the harsh climate.</li>
                <li>Regular servicing guarantees optimal performance and enhanced energy efficiency while helping to avoid costly repairs. This way, you can consistently enjoy a cool and comfortable home.</li>
                </ul>
              </div>
              <div className="col-md-6">
                {/* <img className="blue-border" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`} alt="Post Image" /> */}
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/fujitsu-ac-service.avif`} alt="Gree Ac Repair" />
              </div>
            </div>
            <p>In the UAE, where heat makes AC vital, investing in expert repair like Gree is essential for safety, efficiency, and peace of mind.</p>
          </div>
        </section>
        ...
        <section className="section cs_py_30">
         ...
         {/* testimobial section */}
          <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative" data-background={`${import.meta.env.BASE_URL}${bgImg}`}>
            <div className="cs_height_80 cs_height_Gree_80"></div>
            <div className="container">
              ...
              <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                ...
                <div className="cs_slider_wrapper">
                  <Slider {...settings}>
                    {testimonial_data_GreeAc.map((item, index) => (
