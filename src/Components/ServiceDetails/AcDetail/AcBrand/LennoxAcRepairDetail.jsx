...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/LennoxAcRepairfaq.json';
...
const LennoxAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Lennox AC Repair in Dubai - Air Conditioner Maintenance";
  const description = "Need help finding an Lennox repair in Dubai? Get Lennox air conditioner service near me. We are experts in central & split AC maintenance. Call 043300002";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/lennox-ac-repair-in-dubai-lennox-ac-maintenance-in-dubai-lennox-ac-fix-in-dubai-lennox-ac-service-in-dubai-lennox-air-condition-repair-in-dubai-lennox-air-condition-maintenance-in-dubai-lennox-air-con/";
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Lennox AC Repair in Dubai and Air Conditioning Maintenance</h1>
            <p><a href="https://maps.app.goo.gl/FrdktEqUSR6cgX876"><b>F A J Technical Services L.L.C.</b></a> is your top choice for AC service in Dubai. With 15 years of experience, we are a trusted provider for AC repair and maintenance across all areas of the city.
              <br />
              Our <a href="https://www.facebook.com/ACRepairUAE"><b>skilled AC technicians</b></a> can handle all types and models of Lennox air conditioning units, ensuring your home or business stays cool and comfortable.</p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best Lennox AC Repair in Dubai</h3>
                <p className="mb-2">When it comes to Lennox <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                <p>We specialize in Lennox air conditioner (AC) repair, service, and maintenance in Dubai. The FAJ team is dedicated to ensuring a comfortable temperature all year round.</p>
              ...
              <div className="col-md-6">
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Lennox Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why is Lennox AC Maintenance Service Important in Dubai?</h3>
            <div className="row align-items-center">
              <div className="col-md-6">
                <ul className="mb-0">
                  <li>In Dubai, where the heat can be extreme, it’s vital to keep your Lennox air conditioning units in excellent condition for both comfort and efficiency.</li>
                  <li>Regular maintenance and service for Lennox VRF AC systems are essential as they help prevent unexpected breakdowns, lower energy costs, and prolong the lifespan of your equipment.</li>
                  <li>By opting for professional Lennox AC repair and cleaning services, you’re investing in a cooler and more comfortable environment, whether at home or in your office, making it a smart decision for anyone living in Dubai.</li>
                  <li>Don’t wait for problems to emerge; stay proactive with reliable Lennox central maintenance services for your Lennox AC.</li>
                  <li>Keeping up with routine maintenance is crucial, especially given the harsh climate.</li>
                  <li>Regular servicing not only ensures optimal performance and improves energy efficiency but also helps avoid costly repairs.</li>
                  <li>This way, you can enjoy a consistently cool and comfortable home.</li>
                </ul>
              </div>
              <div className="col-md-6">
                {/* <img className="blue-border" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`} alt="Post Image" /> */}
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/fujitsu-ac-service.avif`} alt="Lennox Ac Repair" />
              </div>
            </div>
          </div>
        </section>
...
{/* testimobial section */}
        <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}${bgImg})` }}>
          <div className="cs_height_80 cs_height_Lennox_80"></div>
          <div className="container">
            ...
            <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              ...
              <div className="cs_slider_wrapper">
                <Slider {...settings}>
                  {testimonial_data_LennoxAc.map((item, index) => (
