...
and <small>3-month parts warranty</small> as standard.</p>
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="LG Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why is LG AC Maintenance Service Essential in Dubai?</h3>
            <div className="row align-items-center">
            <div className="col-md-6">
                <ul className="mb-0">
                    <li>In the hot climate of Dubai, ensuring that your LG air conditioner unit runs efficiently is crucial for comfort and well-being.</li> 
                    <li>Regular LG VRF AC maintenance not only prolongs the lifespan of your system but also enhances its performance, ensuring you enjoy cool air on the hottest days.</li> 
                    <li>With professional LG air conditioner service and maintenance, you can prevent costly breakdowns, improve energy efficiency, and maintain better air quality in your home. Don't wait for an issue to arise; invest in LG AC repair and service today for peace of mind and optimal performance!</li> 
                    <li>In Dubai, maintaining your LG central and split air conditioner system is important for several reasons.</li>
                </ul>
              </div>
              <div className="col-md-6">
                {/* <img className="blue-border" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`} alt="Post Image" /> */}
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/supra-ac-repair.avif`} alt="LG Ac Repair" />
              </div>
              
            </div>
            <p>
            Therefore, supporting professional AC maintenance services for your LG air conditioning system is essential to provide its optimal performance and longevity in Dubai's climate.
            </p>
          </div>
        </section>
