...
import data from '../../../../Data/AcData/AcFaqs/acfaq.json';
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best Midea AC Repair in Dubai</h3>
                        <p className="mb-2">When it comes to Midea <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Midea Ac Repair" />
          ...
          <div className="container">
            ...
            <div className="col-md-6">
              ...
              <div className="col-md-6">
                ...
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/Midea-ac-maintenance.avif`} alt="Midea Ac Repair" />
              </div>
