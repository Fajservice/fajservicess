...
const MideaAcRepair = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/midea-ac-installation-maintenance-repair-fix-service-in-dubai").replace(/\/?$/, '/').replace(/\/?$/, '/');
      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Midea Ac Maintenance and Servicing </h3>
        ...
        <section className="section cs_py_30 bg-light-gray ">
          <div className="container">
            ...
            <h3>We specialise in Midea ac services for the following types</h3>
            <div className="row">
