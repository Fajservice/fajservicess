...
import testimonial_data_MitsubishiAc from '../../../../Data/AcData/AcTestimonial/MitsubishiAcServiceTestimonials.json';
...
const MitsubishiAcRepair = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
      <HelmetProvider>
        <title>Mitsubishi AC Repair in Dubai - Air Conditioner Maintenance</title>
        <meta name="description" content="Are you finding Mitsubishi AC repair in Dubai? Call FAJ Expert 043300002 for central, HVAC, VRF air conditioner maintenance and ac cleaning service near me"/>
      </HelmetProvider>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <p>F A J Technical Services L.L.C. is your top choice for AC service in Dubai. With 15 years of experience, we are a trusted provider for AC repair and maintenance across all areas of the city.
              <br />
              Our skilled AC technicians can handle all types and models of Mitsubishi air conditioning units, ensuring your home or business stays cool and comfortable.</p>
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best Mitsubishi AC Repair in Dubai</h3>
                        <p className="mb-2">When it comes to Mitsubishi <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                        <p>We specialize in Mitsubishi air conditioner (AC) repair, service, and maintenance in Dubai. The FAJ team is dedicated to ensuring a comfortable temperature all year round.</p>
...
and <small>3-month parts warranty</small> as standard.</p>
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Mitsubishi Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why Mitsubishi AC Maintenance Service is Essential in Dubai?</h3>
            <div className="row align-items-center">
            <div className="col-md-6">
                <ul className="mb-0">
                <li>In Dubai, where the heat can be extreme, it’s important to keep your Mitsubishi air conditioning units in excellent condition for both comfort and efficiency.</li>
                <li>Regular maintenance and servicing of Mitsubishi VRF AC systems are essential. They help prevent unexpected breakdowns, lower energy costs, and prolong the lifespan of your equipment.</li>
                <li>By choosing professional Mitsubishi AC repair and cleaning services, you're investing in a cooler and more comfortable environment, whether at home or in your office—making it a smart decision for anyone living in Dubai.</li>
                <li>Don't wait for problems to arise; stay proactive with reliable Mitsubishi maintenance services for your air conditioning units.</li>
              ...
              <div className="col-md-6">
                ...
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/fujitsu-ac-service.avif`} alt="Mitsubishi Ac Repair" />
              </div>
            </div>
            <p>Regular servicing not only ensures optimal performance and improves energy efficiency but also helps avoid costly repairs. This way, you can enjoy a consistently cool and comfortable home.</p>
          </div>
        </section>
        ...
        <section className="section cs_py_30">
         ...
         {/* testimobial section */}
          <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}${bgImg})` }}>
            <div className="cs_height_80 cs_height_Mitsubishi_80"></div>
            <div className="container">
              ...
              <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                ...
                <div className="cs_slider_wrapper">
                  <Slider {...settings}>
                    {testimonial_data_MitsubishiAc.map((item, index) => (
