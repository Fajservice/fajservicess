...
const NikaiAcRepair = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
 ...
 //start fetching
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Nikai AC Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
  ...
  return (
    <>
      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5 align-items-center expert_section_wrapper">
              <div className="col-md-6">
                ...
                <h2 className="cs_fs_24 mb-1 pt-1 mt-0 text-align-left">Top Common Signs That You Need Nikai AC Maintenance</h2>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Nikai AC SYSTEMS</h3>
        ...
        {/*  Benefits */}
        <AcBrandBenifit brandName="Nikai AC"/>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_24 text-align-left">We specialise in Nikai air conditioning services for the following</h3>
            <div className="row">
