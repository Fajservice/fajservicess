...
const PanasonicAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Panasonic Ac Repair In Dubai - AC Maintenace & Service";
  const description = "Get same day Panasonic Ac repair in Dubai Call us at 043300002. We are experts in central & split air conditioner maintenance nearby & AC servicing.";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/panasonic-ac-repair-in-dubai-panasonic-ac-maintenance-in-dubai-panasonic-ac-fix-in-dubai-panasonic-ac-service-in-dubai-panasonic-air-condition-repair-in-dubai-panasonic-air-condition-maintenance-in-du/";
