       ...
       <section className="section cs_py_30 bg-light-gray">
            <div className="container">
                <div className="row gx-md-5">
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}/img/Experts-AC-Service-and-Maintenance.jpg`} alt="Ruud Ac Repair" />
          ...
          <div className="container">
            ...
            <div className="col-md-6">
              ...
              <div className="col-md-6">
                ...
                <img className="blue-border" src={`${import.meta.env.BASE_URL}/img/fujitsu-ac-service.jpg`} alt="Ruud Ac Repair" />
              </div>
