      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30 bg-light-gray">
            <div className="container">
                <div className="row gx-md-5">
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Samsung Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            ...
            <div className="col-md-6">
                <ul className="mb-0">
                    <li>In a city known for its intense heat, keeping your Samsung air conditioning units in top condition is crucial for comfort and efficiency.</li> 
                    <li>Regular Samsung VRF AC maintenance and service help prevent breakdowns, reduce energy costs, and extend the lifespan of your system.</li> 
                    <li>By investing in professional Samsung AC repair and cleaning service, you ensure a cool and pleasant environment in your home or office, making it a smart choice for any Dubai resident.</li> 
                    <li>Don’t wait until issues arise—stay ahead with reliable Samsung central maintenance services for your Samsung AC.</li> 
                    <li>Maintaining your Samsung air conditioner is essential, especially in Dubai's hot climate. Regular service ensures optimal performance, enhances energy efficiency, and extends the lifespan of the unit.</li>
                    <li>Additionally, it helps prevent breakdowns and costly repairs, ensuring your home remains cool and comfortable.</li>
                </ul>
              </div>
              <div className="col-md-6">
                {/* <img className="blue-border" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`} alt="Post Image" /> */}
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/fujitsu-ac-service.avif`} alt="Samsung Ac Repair" />
              </div>
            </div>
          </div>
        </section>
