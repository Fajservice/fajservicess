...
import testimonial_data from '../../../../Data/AcData/AcTestimonial/SamsungAcServiceTestimonials.json';
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-10 text-center">
                <h2 className="cs_fs_30 text-light">Benefits of Regular Samsung AC Service and Maintenance in Dubai </h2>
                ...
                <div className="row mt-4 gx-4 gy-4">
                  ...
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column align-items-center px-2">
                      ...
                      <p className="small">
                        Our team provides feedback on your Samsung AC's health and needed repairs.
                      </p>
                    </div>
                  </div>
                </div>
