...
const SanyoAcRepair = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
      <HelmetProvider>
        <title>Sanyo Ac Repair in Dubai - Air Conditioner Service Near Me</title>
        <meta name="description" content="Get Best Sanyo Ac Repair in Dubai, We are experts in central, split air conditioner maintenance near me and ac service cleaning. Call now 043300002"/>
      </HelmetProvider>
        ...
        <section className="section cs_py_30 bg-light-gray">
            <div className="container">
                <div className="row gx-md-5">
                    ...
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}/img/Experts-AC-Service-and-Maintenance.jpg`} alt="Sanyo Ac Repair" />
          ...
          <div className="container">
            ...
            <div className="col-md-6">
              ...
              <div className="col-md-6">
                ...
                <img className="blue-border" src={`${import.meta.env.BASE_URL}/img/fujitsu-ac-service.jpg`} alt="Sanyo Ac Repair" />
              </div>
            </div>
