...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/SanyoAcRepairfaq.json';
...
import testimonial_data_SanyoAc from '../../../../Data/AcData/AcTestimonial/SanyoAcServiceTestimonials.json';
...
const SanyoAcRepair = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  // For SEO
  const metatitle = String(titleSeo || "Sanyo Ac Repair in Dubai - Air Conditioner Service Near Me");
  const metadescription = String(description || "Get Best Sanyo Ac Repair in Dubai, We are experts in central, split air conditioner maintenance near me and ac service cleaning. Call now 043300002");
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/sanyo-ac-repair-in-dubai-sanyo-ac-maintenance-in-dubai-sanyo-ac-fix-in-dubai-sanyo-ac-service-in-dubai-sanyo-air-condition-repair-in-dubai-sanyo-air-condition-maintenance-in-dubai-sanyo-air-condition/").replace(/\/?$/, '/').replace(/\/?$/, '/');
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Sanyo AC Repair in Dubai - Air Conditioner Service Near Me</h1>
            <p><a href="https://maps.app.goo.gl/FrdktEqUSR6cgX876"><b>F A J Technical Services L.L.C.</b></a> is your top choice for AC service in Dubai. With 15 years of experience, we are a trusted provider for AC repair and maintenance across all areas of the city.
              <br />
              Our <a href="https://www.facebook.com/ACRepairUAE"><b>skilled AC technicians</b></a> can handle all types and models of Sanyo air conditioning units, ensuring your home or business stays cool and comfortable.</p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best Sanyo AC Repair in Dubai</h3>
                <p className="mb-2">When it comes to Sanyo <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                <p>We specialize in Sanyo air conditioner (AC) repair, service, and maintenance in Dubai. The <a href="https://www.facebook.com/FAJTechnicalServicesLLC">FAJ team</a> is dedicated to ensuring a comfortable temperature all year round.</p>
              ...
              <div className="col-md-6">
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Sanyo Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why Sanyo AC Maintenance Service is Essential in Dubai?</h3>
            ...
            <p>In the UAE, where heat makes AC vital, investing in expert repair like Sanyo is essential for safety, efficiency, and peace of mind.</p>
          </div>
        </section>
        ...
        <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}${reviewsbg})` }}>
          <div className="cs_height_80 cs_height_Sanyo_80"></div>
          <div className="container">
            ...
            <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              ...
              <div className="cs_slider_wrapper">
                <Slider {...settings}>
                  {testimonial_data_SanyoAc.map((item, index) => (
