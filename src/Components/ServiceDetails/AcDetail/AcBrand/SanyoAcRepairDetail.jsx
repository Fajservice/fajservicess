...
const SanyoAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Sanyo Ac Repair in Dubai - Air Conditioner Service Near Me";
  const description = "Get Best Sanyo Ac Repair in Dubai, We are experts in central, split air conditioner maintenance near me and ac service cleaning. Call now 043300002";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/sanyo-ac-repair-in-dubai-sanyo-ac-maintenance-in-dubai-sanyo-ac-fix-in-dubai-sanyo-ac-service-in-dubai-sanyo-air-condition-repair-in-dubai-sanyo-air-condition-maintenance-in-dubai-sanyo-air-condition/";
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p>We specialize in Sanyo air conditioner (AC) repair, service, and maintenance in Dubai. The FAJ team is dedicated to ensuring a comfortable temperature all year round.</p>
