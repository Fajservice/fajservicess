...
import data from '../../../../Data/AcData/AcFaqs/AcBrand/SubZeroAcRepairfaq.json';
...
import testimonial_data_SubZeroAc from '../../../../Data/AcData/AcTestimonial/SubZeroAcServiceTestimonials.json';
import parse from 'html-react-parser';
import Slider from "react-slick";
import HeaderForm from "../../../Headeform/HeaderForm";

const SubZeroAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Sub Zero AC Repair in Dubai - Ac Repair & Service Near Me";
  const description = "Sub Zero Ac repair in Dubai, We are experts in central & split air conditioner maintenance service UAE Aircon fix company FAJ Tech Service";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/sub-zero-ac-installation-maintenance-repair-fix-service-in-dubai/";
    ...
    <>
      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best SubZero AC Repair in Dubai</h3>
                <p className="mb-2">When it comes to SubZero <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                <p>We specialize in SubZero air conditioner (AC) repair, service, and maintenance in Dubai. The FAJ team is dedicated to ensuring a comfortable temperature all year round.</p>
              ...
              <div className="col-md-6">
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="SubZero Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why is Sub Zero AC Maintenance Service Important in Dubai?</h3>
            <div className="row align-items-center">
              <div className="col-md-6">
                <ul className="mb-0">
                  <li>In a city like Dubai, where temperatures often soar, having a Sub Zero split AC is vital.</li>
                  <li>The Sub Zero Air Conditioning maintenance and cleaning service ensures that your unit runs efficiently, preventing unexpected breakdowns during the hottest months.</li>
                  <li>Regular air conditioner maintenance of your Sub Zero Split AC isn't just about keeping cool; it's about ensuring efficiency, prolonging the lifespan of your AC unit, and reducing energy costs.</li>
                  <li>With the extreme temperatures, a reliable Sub Zero wall-mounted Air Conditioner unit can make all the difference in your comfort and well-being.</li>
                  ...
                  <li>In Dubai's relentless heat, prioritising your Sub Zero aircon maintenance is a smart choice for both comfort and peace of mind!</li>
                </ul>
              </div>
              <div className="col-md-6">
                {/* <img className="blue-border" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`} alt="Post Image" /> */}
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/fujitsu-ac-service.avif`} alt="SubZero Ac Repair" />
              </div>
            </div>
            <p>In the UAE, where heat makes AC vital, investing in expert repair like SubZero is essential for safety, efficiency, and peace of mind.</p>
          </div>
        </section>
...
{/* testimobial section */}
        <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}${bgImg})` }}>
          <div className="cs_height_80 cs_height_SubZero_80"></div>
          <div className="container">
            ...
            <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              ...
              <div className="cs_slider_wrapper">
                <Slider {...settings}>
                  {testimonial_data_SubZeroAc.map((item, index) => (
