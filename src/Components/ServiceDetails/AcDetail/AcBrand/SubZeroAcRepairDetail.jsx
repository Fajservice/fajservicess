    ...
    <>
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/ac amc.avif`} alt="Sub Zero Airconditioner Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">Common Sub Zero AC Problems That May Require Maintenance</h3>
                ...
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Reduced airflow from a Sub Zero air conditioner may indicate a clogged filter or faulty fan, which should be fixed for efficient cooling.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h3 className="cs_fs_30"> HERE ARE THE SERVICES WE OFFER FOR Sub Zero AIR CONDITIONER SYSTEMS </h3>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-10 text-center">
                <h3 className="cs_fs_30 text-light">Benefits Of Regular Sub Zero AC Service and Maintenance in Dubai </h3>
                ...
                <div className="row mt-4 gx-4 gy-4">
                  ...
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column align-items-center px-2">
                      ...
                      <p className="small">
                        Our team provides vital feedback on your Sub Zero AC's health and any needed repairs.
                      </p>
                    </div>
                  </div>
                </div>
