      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">If you find yourself in Dubai and are in need of Super General <a href="https://www.fajservices.ae/ac-repair-dubai/">air conditioner repair</a>, look no further than FAJ!<br />Our skilled team of professionals is dedicated to ensuring that your air conditioning systems operate at peak performance throughout Dubai and Sharjah.</p>
                      ...
                      <div className="row mt-4 gx-4 gy-4">
                          ...
                          <div className="col-md-4 mb-2">
                              <div className="d-flex flex-column align-items-center px-2">
                                  ...
                                  <p className="small">Our team provides vital feedback on your Super General AC's health and any needed repairs.</p>
                              </div>
                          </div>
                      </div>
        ...
        <section className="section cs_py_30 bg-light-gray ">
          <div className="container">
            ...
            <h3>We specialise in Super General AC services for the following:</h3>
            <div className="row">
