...
import testimonial_data_ToshibaAc from '../../../../Data/AcData/AcTestimonial/ToshibaAcServiceTestimonials.json';
...
const ToshibaAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Toshiba AC Repair in Dubai - AC Maintenance Service Near";
  const description = "Get same day Toshiba AC Repair in Dubai. Call 043300002 FAJ expert for split and central air conditioner maintenance service near by you with less cost cleaning";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/toshiba-ac-repair-in-dubai-toshiba-ac-maintenance-in-dubai-toshiba-ac-fix-in-dubai-toshiba-ac-service-in-dubai-toshiba-air-condition-repair-in-dubai-toshiba-air-condition-maintenance-in-dubai-toshiba/";
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_30">Why is Toshiba AC Maintenance Service Important in Dubai?</h3>
            <p className="">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/ac amc.avif`} alt="Toshiba Airconditioner Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">Common Toshiba AC Problems That May Require Maintenance</h3>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h3 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR Toshiba AIR CONDITIONER SYSTEMS</h3>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-10 text-center">
                <h3 className="cs_fs_30 text-light">Benefits of Regular Toshiba AC Service and Maintenance in Dubai</h3>
                ...
                <div className="row mt-4 gx-4 gy-4">
                  ...
                  <div className="col-md-4 mb-2">
                    <div className="d-flex flex-column align-items-center px-2">
                      ...
                      <p className="small">
                        Our team provides vital feedback on your Toshiba AC's health and any needed repairs.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="section cs_py_30 bg-light-gray ">
          <div className="container">
            ...
            <h3>We specialise in Toshiba air conditioning services for the following</h3>
            <div className="row">
          ...
          <div className="container">
            ...
            <div className="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              ...
              <div className="cs_slider_wrapper">
                <Slider {...settings}>
                  {testimonial_data_ToshibaAc.map((item, index) => (
