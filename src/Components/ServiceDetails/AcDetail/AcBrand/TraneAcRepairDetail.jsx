...
const TraneAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Trane Ac Repair in Dubai - Air Conditioner Maintenance Near";
  const description = "World #1 Trane AC. Book 043300002 for Trane Ac Repair in Dubai, We are experts in central, HVAC Air Conditioning Maintenance and Cleaning Service Near by you";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/trane-ac-repair-in-dubai-trane-ac-maintenance-in-dubai-trane-ac-fix-in-dubai-trane-ac-service-in-dubai-trane-air-condition-repair-in-dubai-trane-air-condition-maintenance-in-dubai-trane-air-condition/";
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Trane Ac Repair in Dubai - Air Conditioner Maintenance and Service Near Me</h1>
            <p><a href="https://maps.app.goo.gl/FrdktEqUSR6cgX876"><b>F A J Technical Services L.L.C.</b></a> is your top choice for AC service in Dubai. With 15 years of experience, we are a trusted provider for AC repair and maintenance across all areas of the city.
              <br />
              Our <a href="https://www.facebook.com/ACRepairUAE"><b>skilled AC technicians</b></a> can handle all types and models of Trane air conditioning units, ensuring your home or business stays cool and comfortable.</p>
        ...
        <section className="section cs_py_30 bg-light-gray mb-4">
          <div className="container">
            <div className="row gx-md-5">
              ...
              <div className="col-md-6">
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/Experts-AC-Service-and-Maintenance.avif`} alt="Trane Ac Repair" />
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Why is Trane AC Maintenance Service Important in Dubai?</h3>
            <p>In Dubai's humid climate, maintaining your Trane HVAC system is essential. Trane AC Maintenance ensures your unit operates efficiently, providing cool, refreshing air during extreme heat.</p>
            <div className="row align-items-center">
              <div className="col-md-6">
                <ul className="mb-0">
                  <li>Regular Trane AC service helps prevent costly breakdowns and identifies potential issues early, saving you on repairs. Routine servicing also extends the lifespan of your unit, protecting your investment.</li>
                  <li>Moreover, regular servicing extends the lifespan of your Trane AC, ensuring that your investment continues to provide comfort for years to come.</li>
                  <li>The FAJ team of skilled technicians delivers top-quality service to keep your Trane AC running smoothly. Don’t let the heat overwhelm you—ensure your home remains a cool cover with reliable Trane AC repair and service.</li>
                  <li>Don’t let the heat overwhelm you—ensure your home remains a cool sanctuary with reliable Trane AC repair and services. Take the proactive step towards comfort today!</li>
                </ul>
              </div>
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/Trane-ac-repair.avif`} alt="Trane Ac Repair" />
              </div>
            </div>
          </div>
        </section>
