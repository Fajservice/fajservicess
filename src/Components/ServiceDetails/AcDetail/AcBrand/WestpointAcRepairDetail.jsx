...
const WestpointAcRepair = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Westpoint AC Repair in Dubai - Air Conditioner Service Near";
  const description = "Are You Looking for Westpoint AC repair in Dubai? We are experts in split air conditioner maintenance and service near me Dubai Call 04330 0002";
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best Westpoint AC Repair in Dubai</h3>
                <p className="mb-2">When it comes to Westpoint <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
