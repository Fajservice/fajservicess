...
const AcRepairInAlBarshaDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
    ...
    // For SEO
    const metatitle = String(titleSeo || "Best AC Repair in Al Barsha | HVAC Maintenance Services");
    const metadescription = String(description || "Get AC Repair in Al Barsha, Dubai. We are experts in the maintenance and servicing of central & split AC near you. Contact us for same  fix AC");
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30 bg-light-white">
                    <div className="container">
                        <h1 className="cs_fs_30">AC Repair and Maintenance Services in Al Barsha, Dubai</h1>
