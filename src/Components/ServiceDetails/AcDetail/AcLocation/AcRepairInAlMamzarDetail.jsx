...
const AcRepairInAlMamzarDetail = ({ subtitle, title, bgImg }) => {
    ...
    // For SEO
    const titleSeo = "AC Repair and Service in Al Mamzar - Gree AC Maintenance";
    const description = "Get same day AC repair and service in Al Mamzar Dubai. Call now 043300002 for your Gree air conditioner repairs and fix Gree AC error near you Dubai";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-repair-and-ac-service-in-al-mamzar";
