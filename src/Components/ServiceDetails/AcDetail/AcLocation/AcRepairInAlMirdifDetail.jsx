...
const AcRepairInAlMirdifDetail = ({ subtitle, title, bgImg }) => {

   // For SEO
    const titleSeo = "AC Services In Al Mirdif - Inverter AC Repairs Near Me #1";
    const description = "FAJ Provides Inverter AC Services in Al Mirdif, Our Technicians are Experts in HVAC Air Condition Maintenance & Repair near me Dubai AC Fixing.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-al-mirdif";
