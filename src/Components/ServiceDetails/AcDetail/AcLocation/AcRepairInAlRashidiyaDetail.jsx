...
const AcRepairInAlRashidiyaDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
        <title>AC Services in Al Rashidiya - Best AC Maintenance Dubai</title>
        <meta name="description" content="Efficient AC Services in Al Rashidiya Dubai. Inverter, central and split air conditioner maintenance service near me Dubai. Call now at 043300002"></meta>
    </HelmetProvider>
    <HeaderForm />
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in Al Rashidiya</h3>
