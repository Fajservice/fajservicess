...
const AcRepairInAlTawarDetail = ({ subtitle, title, bgImg }) => {
    ...
    const titleSeo = "Emergency AC Services In Al Tawar - Split AC Repair Dubai #1";
    const description = "Are you finding AC Services in Al Tawar? Contact us 043300002 for your Ac Cooling Problem Air Conditioner Maintenance, Air con Repair your Area.";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-al-tawar";
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best AC Repair in Al Tawar</h3>
