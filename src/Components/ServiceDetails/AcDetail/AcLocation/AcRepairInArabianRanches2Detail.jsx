...
const AcRepairInArabianRanches2Detail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In Arabian Ranches 2 - Aircon Fix - Ac Repair #1";
    const description = "FAJ AC Services in Arabian Ranches 2 Dubai. We are experts in central, Carrier, LG Air Conditioner repair, maintenance near me Dubai AC fix";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-arabian-ranches-2";
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best AC Repair in Arabian Ranches 2</h3>
