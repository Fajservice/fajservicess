...
const AcRepairInArabianRanches2Detail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
    ...
    // For SEO
    const metatitle = String(titleSeo || "Get Best AC Repair & Maintenance Services in Arabian Ranches 2");
    const metadescription = String(description || "Expert AC repair and service in Arabian Ranches 2, Dubai. We specialize in central, Carrier, and LG air conditioning maintenance and repairs near you");
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30 bg-light-white">
                    <div className="container">
                        <h1 className="cs_fs_30">Reliable and Fast AC Repair and Maintenance Services in Arabian Ranches 2, Dubai</h1>
                    ...
                    <div className="container">
                        <div className="row gx-md-5 expert_section_wrapper">
                            <div className="col-md-6">
                                <h2 className="cs_fs_24 mb-1 text-align-left">Best AC Repair in Arabian Ranches 2</h2>
                ...
                <AcBenefits city="Arabian Ranches 2" />
