...
const AcRepairInArabianRanchesDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In Arabian Ranches - Air Con Repair Near Me #1";
    const description = "Are you finding for AC Services in Arabian Ranches Dubai? Dail 043300002 for Carrier, LG air conditioning repair and maintenance near me. AC fix";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-arabian-ranches";
