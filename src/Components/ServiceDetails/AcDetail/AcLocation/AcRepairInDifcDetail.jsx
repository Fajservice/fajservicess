...
const AcRepairInDifcDetail = ({ subtitle, title, bgImg }) => {
     ...
     // For SEO
    const titleSeo = "AC Services In DIFC - AC Maintenance Company In Dubai #1";
    const description = "Contact us: 043300002. AC Services in DIFC. Our team is experts in central HVAC maintenance & repair near me Dubai AC fix servicing company";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-difc";
