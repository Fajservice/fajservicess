                ...
                <section className="section cs_py_30 bg-light-gray">
                    <div className="container">
                        <div className="row gx-md-5">
                            ...
                            <div className="col-md-6 ">
                                <img className="bordered-img w-100" src={getImageSrc('Experts-AC-Service-and-Maintenance')} alt="AC Repair in DIP"  />
                ...
                <section className="section cs_py_30 bg-light-gray">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={getImageSrc('What-is-covered-in-an-AC-Maintenance-Contract')} alt="Air Conditioning Service in DIP"  />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4">
                                <div className="acsvs-sec-prefoot-sec-ctwo">
                                    <img src={getImageSrc('benafit-acimg')} alt="Air Con Maintenance & AC Installation in DIP"  />
                                </div>
                            </div>
                            <div className="col-lg-4">
