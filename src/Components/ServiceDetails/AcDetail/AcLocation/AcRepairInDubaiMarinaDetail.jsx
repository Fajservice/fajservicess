...
const AcRepairInDubaiMarinaDetail = ({ subtitle, title, bgImg }) => {
    ...
    // For SEO
    const titleSeo = "AC Services In Dubai Marina - #1 Air Conditioner Repairs";
    const description = "Get it done affordably cost. Dail now 043300002 for ac services in dubai marina and best chiller fcu air conditioner repair & maintenance near me";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-dubai-marina/";
