...
const AcRepairInDubailandTheVillaPointDetail = ({ subtitle, title, bgImg }) => {
    ...
    // For SEO
    const titleSeo = "AC Services In Dubailand The Villa Point - Aircon Fixing";
    const description = "FAJ is here to help you with AC Services in Dubailand The Villa Point. Dail 043300002 for central air conditioning maintenance nearby in Dubai";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-dubailand-the-villa-point";
