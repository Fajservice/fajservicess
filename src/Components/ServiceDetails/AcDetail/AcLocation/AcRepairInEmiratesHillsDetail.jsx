...
const AcRepairInEmiratesHillsDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In Emirates Hills - #1 Air Conditioner Repairs";
    const description = "Get your fahu, vrv, vrf or central air conditioning units repaired on an urgent basis. Dail 043300002 for ac services in emirates hills near me dubai";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-emirates-hills";
