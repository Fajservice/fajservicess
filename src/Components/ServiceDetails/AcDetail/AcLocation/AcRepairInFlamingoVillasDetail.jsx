...
const AcRepairInFlamingoVillasDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In Flamingo Villas - AC Maintenance - AC Fix";
    const description = "Dial 043300002 AC Services in Flamingo Villas Dubai. We are experts in central & split air conditioning repair and maintenance service near me";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-flamingo-villas/";
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best AC Repair in Flamingo Villas</h3>
