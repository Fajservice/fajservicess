...
const AcRepairInImpzDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "Best AC Services In IMPZ - AC Maintenance - AC Repairing #1";
    const description = "Call 043300002 AC Services in IMPZ Dubai. We are experts in central & split air conditioner repairing and maintenance near me Dubai AC fixing";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-impz";
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best AC Repair in IMPZ</h3>
