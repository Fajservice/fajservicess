...
const AcRepairInIndexTowerDifcDetail = ({ subtitle, title, bgImg }) => {
    ...
    // For SEO
    const titleSeo = "Best AC Services In Index Tower DIFC - AC Servicing #1";
    const description = "Ph:043300002. AC Services in Index Tower Difc. Get best and quick HVAC repair service near me Dubai AC fix Air Con repairs";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-index-tower-difc";
