...
const AcRepairInInvestmentsParkDetail = ({ subtitle, title, bgImg }) => {
     ...
     // For SEO
    const titleSeo = "AC Services In Dubai Investments Park - Split Aircon Fixing";
    const description = "Dial 043300002 for AC Services in Dubai Investments Park. We are experts in central & split Air Conditioner repair & maintenance near me Dubai";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-dubai-investments-park";
