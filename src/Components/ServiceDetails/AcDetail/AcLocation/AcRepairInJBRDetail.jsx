...
const AcRepairInJBRDetail = ({ subtitle, title, bgImg }) => {
    ...
    // For SEO
    const titleSeo = "AC Services In JBR - Chilled Water FCU Repair Near Me #1";
    const description = "Get quality AC Services in JBR Dubai. We are offering the best chiller fan coil unit air conditioner repair, maintenance and aircon fix Call:043300002";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-jbr";
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in JBR</h3>
