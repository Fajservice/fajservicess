...
const AcRepairInJebelAliDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In Jebel Ali Dubai - Air Conditioner Repairs #1";
    const description = "FAJ is here to help with AC Services in Jebel Ali Dubai. Call now 043300002 for central, ducted, hvac split air conditioner repair & maintenance. Fix";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-jebel-ali";
