...
const AcRepairInJebelAliVillageDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In Jebel Ali Village Dubai - Air Conditioner Fix";
    const description = "Call now 043300002 for AC Services in Jebel Ali Village Dubai. FAJ here to help you package unit, ceiling air conditioner repair & maintenance near..";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-jebel-ali-village/";
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in Jebel Ali Village</h3>
