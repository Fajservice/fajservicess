...
const AcRepairInJqeDetail = ({ subtitle, title, bgImg }) => {

    // For SEO
    const titleSeo = "AC Services In JGE Dubai - #1 Daikin VRV - Mitsubishi VRF";
    const description = "Dial FAJ: 043300002 AC Services in JGE Dubai. We are experts in central & multi split ac (air conditioner) repairs & maintenance service near me";
    const Author = "Faj Technical Services";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/ac-services-in-jge";
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in JGE Dubai</h3>
