...
import testimonial from '../../../../Data/AcData/AcTestimonial/AcServiceInDubai.json';
import loadBackgroudImages from "../../../Common/loadBackgroudImages";
import parse from 'html-react-parser';
import HeaderForm from "../../../Headeform/HeaderForm";
import WeSpecialise from "./WeSpecialise/WeSpecialise";

const AcRepairInJumeirahHeightsDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
      <title>AC Services In Jumeirah Heights Dubai - #1 A/C Servicing</title>
      <meta name="description" content="If you are looking for best ac services in jumeirah heights dubai. Call 043300002 for centralized a/c system repairing and a/c fixing in my location "></meta>
    </HelmetProvider>
    <HeaderForm />
        ...
        <div className="container">
          <div className="row gx-md-5">
            <div className="col-md-6">
              <h3 className="cs_fs_24 mb-1">Best AC Repair in Jumeirah Heights Dubai</h3>
