                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-6">
                                <ul className="mb-0">
                                    ...
                                    <li> <strong> Enhanced Comfort: </strong> Regular <a href="https://www.youtube.com/watch?v=pkO_jobGdBo"><b>AC cleaning service</b></a> in Jumeirah Park Dubai ensures comfort, efficiency, and consistent cooling daily.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="uspcol col-1">
                                ...
                                <div className="uspitem mb-0">
                                    ...
                                    <div className="usptext">
                                        ...
                                        <p>Choose a day and time for your AC repair near me, Jumeirah Park Dubai or Sharjah. With a 3-4 hour window for when our technician will arrive..
                                        </p>
                                    </div>
                                </div>
