...
const AcRepairInJvcDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
        <title>AC Repair JVC Near Me Cost - AC Services in JVC Dubai #1</title>
        <meta name="description" content="Get same day AC repair in JVC. Call 043300002 for central, split air conditioner repair & maintenance. Best AC cleaning service near me Dubai"></meta>
    </HelmetProvider>
    <HeaderForm />
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in JVC</h3>
