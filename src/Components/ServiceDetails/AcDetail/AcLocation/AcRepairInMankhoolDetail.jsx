...
const AcRepairInMankhoolDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
        <title>AC Services In Mankhool - Aircon Repair And Maintenance #1</title>
        <meta name="description" content="A/C Repair, Maintenance and AC Services in Mankhool. Call 043300002 for Central Air Conditioner, Split A/C Repairing, Servicing in my location"></meta>
    </HelmetProvider>
    <HeaderForm />
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in Mankhool</h3>
