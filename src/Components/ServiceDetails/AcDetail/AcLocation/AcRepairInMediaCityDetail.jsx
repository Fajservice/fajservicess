...
const AcRepairInMediaCityDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
        <title>AC Services In Media City - #1 Air Conditioning Repairs</title>
        <meta name="description" content="Get it done affordably. Dail now 043300002 for ac services in media city dubai and the best chiller air conditioner repair & maintenance and fix aircon"></meta>
    </HelmetProvider>
    <HeaderForm />
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in  Media City</h3>
