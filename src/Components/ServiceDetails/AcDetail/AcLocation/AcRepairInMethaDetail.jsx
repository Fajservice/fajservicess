...
const AcRepairInMethaDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
    ...
    const metaKeyword = String(Keyword || "AC Repair & Service in Oud Metha, AC Maintenance in Oud Metha, AC Installation in Oud Metha, AC Technician in Oud Metha");
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best AC Repair in Oud Metha</h3>
