...
const AcRepairInMotorCityDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
            <HelmetProvider>
                <title>AC Services In Motor City Dubai - Air Conditioner Fixing #1</title>
                <meta name="description" content="T:043300002 FAJ AC Services in Motor City Dubai. We are experts in air conditioner maintenance and repair near me Dubai AC fix Air Con repairs"></meta>
            </HelmetProvider>
            <HeaderForm />
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best AC Repair in Motor City</h3>
