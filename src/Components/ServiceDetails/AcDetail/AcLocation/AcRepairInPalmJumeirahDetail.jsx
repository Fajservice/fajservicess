...
const AcRepairInPalmJumeirahDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
        <title>AC Services In Palm Jumeirah - #1 Central Cooling Repair</title>
        <meta name="description" content="If you are looking for Trane or Chiller FCU AC Services in Palm Jumeirah, Call FAJ 043300002 for Air Conditioner Maintenance & Service in Dubai"></meta>
    </HelmetProvider>
    <HeaderForm />
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in Palm Jumeirah</h3>
