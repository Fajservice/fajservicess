...
import data from '../../../../Data/AcData/AcFaqs/AcRepairInQuozIndustrialArea.json';
...
const AcRepairInQuozIndustrialAreaDetail = ({ subtitle, title, bgImg }) => {
        ...
        <div className="container">
          <div className="row gx-md-5">
            <div className="col-md-6">
              <h3 className="cs_fs_24 mb-1">Best AC Repair in Al Quoz Industrial Area</h3>
