...
const AcRepairInQuozIndustrialAreaDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metadescription = String(description || "Get affordable AC repair in Al Quoz Industrial Area, Dubai. Book your ceiling, central, & split air conditioning maintenance & servicing near me. 04 3300002");
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Same-Day AC Repair and Maintenance Services in Al Quoz Industrial Area, Dubai</h1>
          ...
          <div className="container">
            <div className="row gx-md-5 expert_section_wrapper">
              <div className="col-md-6">
                <h2 className="cs_fs_24 mb-1 mt-0 text-align-left">Best AC Repair in Al Quoz Industrial Area</h2>
