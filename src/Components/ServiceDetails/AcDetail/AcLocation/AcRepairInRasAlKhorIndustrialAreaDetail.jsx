                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-6">
                                <ul className="mb-0">
                                    ...
                                    <li> <strong> Enhanced Comfort: </strong> Regular AC cleaning service in Ras Al Khor Industrial Area Dubai ensures comfort, efficiency, and consistent cooling daily.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
