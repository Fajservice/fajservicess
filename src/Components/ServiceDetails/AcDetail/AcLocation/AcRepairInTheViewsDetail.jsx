...
const AcRepairInTheViewsDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
        <title>AC Services In The Views - #1 AC Maintenance - A/C Fixing</title>
        <meta name="description" content="Get it done affordably cost. Call FAJ 043300002 for ac services in the views dubai and the best chiller air conditioner repairs & maintenance dubai"></meta>
    </HelmetProvider>
    <HeaderForm />
            ...
            <div className="container">
                <div className="row gx-md-5">
                    <div className="col-md-6">
                        <h3 className="cs_fs_24 mb-1">Best AC Repair in The Views</h3>
