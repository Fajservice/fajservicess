  ...
  const servicesData = useMemo(() => [
    {
      ...
      sections: [
        ...
        { paragraph: '**Terms & Conditions:** <br> *Starting from AED 195 callout fee applies based on the type, capacity of the unit, and location for each diagnosis.' },
      ],
    },
    {
      id: 2,
      ...
      sections: [
        ...
        { paragraph: '**Excluded:** <br> Cost for any repair work, procurement cost, cost of any new parts and installation, if required.' },
        { paragraph: '**Terms & Conditions:** <br> *Starting from AED 280 basic cleaning service charge applies based on the type, capacity of the unit, and location for each diagnosis.' },
      ],
    },
    {
      id: 3,
      ...
      sections: [
        ...
        { paragraph: '**Excluded:** <br> Cost for any repair work, procurement cost, cost of any new parts and installation, if required.' },
        { paragraph: '**Terms & Conditions:** <br> *Starting from AED 325 AC Maintenance charge applies based on the type, capacity of the unit, and location for each diagnosis.' },
      ],
    },
  ], []);
