...
<li><strong>راحة مُعززة:</strong> تضمن الصيانة الدورية لمكيفات الهواء في دبي الراحة والكفاءة والتبريد المستمر يوميًا.</li>
    ...
    <div className="container">
        ...
        {/* قسم الشهادات */}
        <section className="cs_slider cs_style_1 cs_slider_gap_30 cs_bg_filed position-relative cs_py_30" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}${reviewsbg})` }}  dir="ltr">
