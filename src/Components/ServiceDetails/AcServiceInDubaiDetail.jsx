        ...
        <div className="container">
          <div className="row cs_row_gap_30 cs_gap_y_60">
            <div className="col-xl-8 col-lg-7">
              ...
              <h2 className="cs_fs_30">The FAJ Experts Team can help you make your house or place of business more comfortable</h2>
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <h3 class="cs_fs_24">Experts AC Service and Repair</h3>
                  ...
                  <div className="col-md-6">
                    ...
                    <h3 class="cs_fs_24">Signs You Need An AC Service</h3>
                ...
                <h3 class="cs_fs_24">Ready to Beat the Heat? Find the Best AC Repair in Dubai</h3>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6">
                    <h3 class="cs_fs_24">Choose FAJ for Speed, Efficiency and Peace of Mind</h3>
                ...
                <h3 class="cs_fs_24">AC Duct Cleaning Service in Dubai</h3>
            ...
            <aside className="col-xl-4 col-lg-5">
              <div className="cs_sidebar cs_style_1">
                <div className="cs_sidebar_widget cs_accent_bg_light position-relative">
                  ...
                  <h3 class="cs_fs_24" className="cs_sidebar_title cs_fs_30 cs_mb_43">All Services</h3>
                ...
                <div className="cs_sidebar_widget cs_accent_bg">
                  <div className="cs_card cs_style_6">
                    <h3 class="cs_fs_24" className="cs_fs_30 cs_white_color cs_mb_30">Emergency AC Repair Services</h3>
