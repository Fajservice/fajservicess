...
const AdmiralFridgeRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
    ...
    const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/brands/admiral/");
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Admiral Home Appliance Repair and Service in Dubai – Fast & Reliable - FAJ Technical Services L.L.C",
      "image": [
        "https://imagedelivery.net/7jVKF8FS0aEmjeSSRZqLyA/FajLogo1/public"
      ],
      "url": "https://www.fajservices.ae/services/home-appliances-repair/brands/admiral/",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Admiral Home Appliances Repair Services",
        "itemListElement": [
          {
            "@type": "OfferCatalog",
            "name": "Admiral Appliance Service",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Washing Machine Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Fridge Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Freezer Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Dishwasher Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Cooking Range and Oven Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Dryer Repair and Service" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Oven Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Home Appliance Service Center" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Admiral Appliance Annual Maintenance Contract" } }
            ]
          }
        ]
      },
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.fajservices.ae/services/home-appliances-repair/brands/admiral/#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 5, "name": "Admiral", "item": "https://www.fajservices.ae/services/home-appliances-repair/brands/admiral/" }
      ]
    }
  ]
}
    ...
    return (
        <>
            ...
            <div className="cs_service_details">
                    ...
                    <div className="container">
                        <div className="row gx-md-5 align-items-center">
                            ...
                            <div className="col-md-6 ">
                                ...
                                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')} alt="Admiral Washing Machine Repair" />
                            </div>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Refrigerator</h3>
                                    </div>
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Dishwasher</h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Washing Machine</h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Tumble Dryer</h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Cooker / Stove</h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Oven</h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Admiral Freezer</h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Admiral APPLIANCES</h2>
                ...
                <section className="section cs_py_30 appliances-benifit-sec bg-dark-blue">
                    <div className="container">
                        <div className="row justify-content-center">
                            <h2 className="cs_fs_30 mb-0 text-light">The Benefits of Admiral Appliances Service Dubai</h2>
                            ...
                            <div className="uspcol col-1">
                                ...
                                <div className="uspitem">
                                    ...
                                    <div className="usptext">
                                        ...
                                        <p>With a <Link to="/services/home-appliances-repair/appliances-amc-service/"> maintenance contract</Link>,  you get year-round service to keep your Admiral appliance running smoothly and reliably.</p>
                                    </div>
                                </div>
                ...
                <section className="section cs_py_30 bg-light-gray mb-4">
                    <div className="container">
                        <DaiganosisCharges
                            appliancebrand="Admiral Appliance"
                            feeRange="ranging from AED 157 to 280"
                        />
                        <h3>We specialize in Admiral appliance services of the following types</h3>
                        <div className="row">
                            <div className="col-12">
                                <p className="mb-0"> <b> Admiral Washing Machine Repair Near You in Dubai: </b> FAJ is here to support you when issues arise. We understand that your Admiral washing machine is vital for daily life, ensuring your laundry stays clean. Contact us for the best Admiral <a href="https://www.fajservices.ae/services/home-appliances-repair/washing-machine-repair-service-dubai/">washing machine service center</a> near me in Dubai. </p>
                                <p className="mb-0"> <b> Admiral Fridge Repair Near You in Dubai: </b> If you are having problems with your Admiral refrigerator, please contact the FAJ team for same-day Admiral <a href="https://www.fajservices.ae/services/home-appliances-repair/refrigerator-repair-service/">refrigerator repair service</a> in Dubai. </p>
                                ...
                                <p className="mb-0"> <b> Admiral Oven Repair Near Me Dubai: </b> If you're searching for the best company for Admiral <a href="https://www.fajservices.ae/services/home-appliances-repair/oven-repair-service/">oven repair</a> in Dubai, FAJ is an excellent choice. They are renowned for providing exceptional service specifically for Admiral ovens. FAJ is recognized as the leading service center for Admiral oven repair and maintenance in Dubai. </p>
...
export default AdmiralFridgeRepairDetail;