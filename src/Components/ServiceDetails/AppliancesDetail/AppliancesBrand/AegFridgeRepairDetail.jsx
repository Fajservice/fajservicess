...
const AegFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
   <>
        <HelmetProvider>
          <title>AEG Fridge Repair - AEG Washing Machine Service Dubai</title>
          <meta name="description" content="AEG fridge Repair and washing machine services Dubai. Our skilled team provides services like aeg dishwasher, oven, and dryer repair in Dubai"></meta>
        </HelmetProvider>
        <HeaderForm />
