...
const AristonFrideRepairDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Ariston Fridge Repair - Ariston Washing Machine Service";
  const description = "Ariston Fridge Repair Dubai - We offer expert washing machines, water heaters, dishwashers, dryers, ovens, and stove repair services.";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/ariston-fridge-repair-in-dubai-ariston-washing-machine-repair-in-dubai-ariston-cooker-repair-in-dubai-ariston-oven-repair-in-dubai-ariston-appliances-maintenance-in-dubai-ariston-refrigerator-fix-repa/";
