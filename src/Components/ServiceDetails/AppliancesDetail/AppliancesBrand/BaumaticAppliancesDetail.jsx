...
const BaumaticAppliancesDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Best Baumatic Appliances - Washing Machine Repair Dubai #1";
    const description = "FAJ technicians fully professional in Baumatic appliances service in Dubai, Experts in fridge, refrigerator, washing machine, dishwasher, oven repair";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.com/baumatic-appliances/";
