...
const BaumaticRefrigeratorRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  const URL = "https://fajservices.com/baumatic-refrigerator-repair-in-dubai-fridge-repair-in-dubai-washing-machine-repair-in-dubai-dishwasher-cooker-oven-repairs-fix-service-in-dubai-error/";
