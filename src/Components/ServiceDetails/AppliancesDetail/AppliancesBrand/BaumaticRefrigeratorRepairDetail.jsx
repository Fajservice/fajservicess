      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Baumatic Fridge Repair & Service</h1>
            {/* 
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <div className="row gx-md-5">
              ...
              <div className="col-md-6 ">
                {/* <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`}  loading="lazy" alt="Baumatic Fridge Repair" /> */}
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/The-Most-Common-Reasons-for-Appliance-Breakdowns.avif`}  loading="lazy" alt="Baumatic Fridge Repair" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/dishwasher-repair-service.avif`}  loading="lazy" alt="Baumatic Fridge Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
