...
const BoschHomeApplianceDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
   <>
        <HelmetProvider>
          <title>Bosch Home Appliance Repair - Washing Machine Service</title>
          <meta name="description" content="Bosch Home Appliances Repair - Expert Bosch washing machine repair, Bosch refrigerator repair, fridge, Bosch diswasher, stove and oven repair."></meta>
        </HelmetProvider>
        <HeaderForm />
