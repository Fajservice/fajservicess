...
const BoschHomeApplianceDetail = ({ subtitle, title, bgImg }) => {
  // For SEO        
  const titleSeo = "Bosch Home Appliance Repair - Washing Machine Service";
  const description = "Bosch Home Appliances Repair - Expert Bosch washing machine repair, Bosch refrigerator repair, fridge, Bosch diswasher, stove and oven repair.";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/bosch-home-appliances-repair/";
