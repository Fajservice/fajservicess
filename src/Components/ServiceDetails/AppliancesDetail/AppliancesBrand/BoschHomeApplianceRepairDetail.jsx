...
const BoschHomeApplianceRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
            <HelmetProvider>
                <title>Bosch Appliance - Fridge & Washing Machine Repair Service</title>
                <meta name="description" content="Bosch home appliancs services. Expert Bosch washing machine repair, Bosch refrigerator, fridge, oven, cooker, dishwasher service near you Dubai"></meta>
            </HelmetProvider>
            <HeaderForm />
