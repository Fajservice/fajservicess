...
const BostonRefrigeratorRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  const Keyword = "";
  const URL = "https://www.fajservices.comboston-refrigerator-repair-in-dubai-boston-appliances-service-boston-fridge-repair-in-dubai-boston-washing-machine-washer-boston-dryer-repair-in-dubai-boston-dishwasher-cooker/";
