...
const CandyRefrigeratorRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  ...
  // For SEO
  const metatitle = String(titleSeo || "Candy Home Appliance Service and Candy Fridge Repair in Dubai");
  const metadescription = String(description || "With Warranty Candy home appliances service in Dubai. Call us for your Candy washing machine, dryer, dishwasher, stove & oven, repair center near you");
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Candy Home Appliances Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
        "https://imagedelivery.net/7jVKF8FS0aEmjeSSRZqLyA/FajLogo1/public"
      ],
      "url": "https://www.fajservices.ae/services/home-appliances-repair/brands/candy/",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Candy Home Appliances Repair Services",
        "itemListElement": [
          {
            "@type": "OfferCatalog",
            "name": "Candy Appliances Services",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Washing Machine Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Fridge Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Freezer Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Home Appliance Service Center" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Dishwasher Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Cooking Range and Oven Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Dryer Repair and Service" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Candy Oven Repair" } }
            ]
          }
        ]
      },
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.fajservices.ae/services/home-appliances-repair/brands/candy/#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 5, "name": "Candy", "item": "https://www.fajservices.ae/services/home-appliances-repair/brands/candy/" }
      ]
    }
  ]
}
...
{/* Best Home Appliance Service Center */}
          ...
          <div className="container">
            <div className="row gx-md-5 align-items-center">
              <div className="col-md-6">
                <h2 className="cs_fs_20 mb-1 mt-0 text-align-left">Specialised Candy Washing Machine Repair and Service in Dubai</h2>
              ...
              <div className="col-md-6 ">
                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')} alt="Candy Washing Machine Repair" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_30">Why is Candy Appliance Maintenance Service Important in Dubai?</h3>
            <p className="mb-0">
              Our comprehensive repair services encompass diagnosis, repairs, installations, and maintenance. This is why we are the leading provider of Candy appliance maintenance in Dubai.
            </p>

            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')} alt="Candy Washing Machine Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
                  <li> <strong> Candy Washing Machine Repair in Dubai: </strong> Regular maintenance can extend the lifespan of your washing machine, ultimately saving you money on replacement costs. </li>
                  <li> <strong> Candy Fridge Repair in Dubai: </strong> We are fully confident that we can get your Candy refrigerator running again in no time. </li>
                  <li> <strong> Candy Stove / Oven Repair in Dubai: </strong> Identifying minor issues early helps prevent them from developing into costly repairs. </li>
                  <li> <strong> Candy Dishwasher Repair in Dubai: </strong> Consistent maintenance helps reduce potential issues and enhances overall performance. </li>
                  ...
                  <li> <strong> Energy Efficiency: </strong> Regular maintenance of your Candy appliances can improve their efficiency and help you save money. </li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">The Most Common Problems with Candy Appliances </h3>
            <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">

              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Refrigerator</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Common malfunctions of Candy refrigerators often involve cooling issues, such as problems with the defrost, fan motor, compressor, or coils.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Dishwasher</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Common issues with Candy dishwasher include poor cleaning and drying, water leaks, drainage problems, and occasional electrical or PCB failures.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Washing Machine</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Candy washing machines include drainage problems, leaks, faulty PCBs, and issues with the belt, door switch, or drum spinning.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Tumble Dryer</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Candy dryers may stop spinning and make noise while failing to dry clothes. Common issues include a faulty heating element or control board.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Cooker / Stove</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Common issues with Candy stoves include uneven heating and flame problems, such as a broken burner element, faulty switch, or an electric gas malfunction.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Oven</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Candy ovens often have issues like improper heating, unignited burners, ignition problems in gas models, and faulty knobs or controls.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Candy Freezer</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Common Candy freezer include frequent water leaks, consistently low ice production, a faulty ice maker, and noticeably reduced cooling efficiency.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Candy APPLIANCES</h2>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                <p className='mb-0'>We specialise in all types of Candy appliances, including built-in Candy appliances.</p>
                <p className='mb-0'><strong>Our services include:</strong></p>
                <ul className="cs_list cs_style_ cs_fs_16 cs_mp_ mb-0">
                  <li> <strong> Candy Appliance Installation: </strong> Professional installation of various types of Candy home appliances ensures optimal performance and efficiency. </li>
                  <li> <strong> Candy Appliance Diagnostics: </strong> We provide expert diagnostics and eligibility assessments, along with detailed quotes for Candy appliance issues. </li>
                  <li> <strong> Candy Appliance Repair Service: </strong> We provide fast and effective repair services for Candy appliances, quickly addressing leaks, electrical issues, and malfunctions. Contact us for details on specific services or any questions you may have! </li>
                  <li> <strong> Candy Appliance Annual Maintenance Contract: </strong> This contract details the terms for annual maintenance of your Candy appliances, ensuring they operate smoothly all year. Enjoy peace of mind with expert care. </li>
                </ul>
                <p className="mb-0">
                  <a href="https://www.linkedin.com/company/faj-technical-services-llc">Regular maintenance</a>  is crucial for ensuring your Candy home appliances perform optimally, run efficiently, and last longer.
                </p>
              </div>
        ...
        <section className="section cs_py_30 appliances-benifit-sec bg-dark-blue">
          <div className="container">
            <div className="row justify-content-center">
              <h2 className="cs_fs_30 mb-0 text-light">The Benefits of Candy Appliances Service Dubai</h2>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Regular maintenance helps your Candy appliances run smoothly and efficiently, delivering the best results every time.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Energy-efficient Candy appliances lead to monthly savings on utility bills, allowing you to keep more money in your pocket.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Preventive services identify issues early, minimizing breakdowns and repairs while extending the lifespan of Candy appliances.
                      </p>
                    </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Proper maintenance and timely servicing can greatly extend the lifespan of your Candy appliances, postponing the need for replacements.
                      </p>
                    </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Ensuring your Candy appliances are functioning well boosts your confidence and reduces the stress of unexpected failures.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>With a <Link to="/services/home-appliances-repair/appliances-amc-service/"> maintenance contract</Link>,  you get year-round service to keep your Candy appliance running smoothly and reliably.</p>
                  </div>
                </div>
                ...
                <div className="uspitem mb-0">
                  ...
                  <div className="usptext">
                    ...
                    <p>Choose a day and time for your Candy appliance repair in Dubai or Sharjah, allowing a 3-4 hour window for our technician's arrival.</p>
                  </div>
                </div>
              ...
              <div className="uspcol col-3">
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p> We are specialists in Candy appliance repair, which is why major brands trust us to manage their service and maintenance.</p>
                  </div>
                </div>
                <div className="uspitem">
                  <div className="uspicon">
                  ...
                  <div className="usptext">
                    ...
                    <p>Inspection fee includes diagnosis, transport, and reinstallation up to two Candy appliances at the same location in Dubai.</p>
                  </div>
                </div>
                <div className="uspitem mb-0">
                  <div className="uspicon">
                  ...
                  <div className="usptext">
                    ...
                    <p>Our skilled technicians specialise in Candy appliances and provide outstanding service across major appliances.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30 bg-light-gray mb-4">
          <div className="container">
            <DaiganosisCharges
              appliancebrand="Candy Appliance"
              feeRange="ranging from AED 157 to 280"
            />
            <h3>We specialize in Candy appliance services of the following types</h3>
            <div className="row">
              <div className="col-12">
                <p className="mb-0"> <b> Candy Washing Machine Repair Near You in Dubai: </b>  FAJ is here to support you when things go wrong. We understand that your Candy washing machine is essential for daily life, keeping your laundry clean.</p>
                <p className="mb-0"> <b> Candy Fridge Repair Near You in Dubai: </b> If you are experiencing issues with your Candy refrigerator, please contact the FAJ team for same-day Candy <a href="https://www.fajservices.ae/services/home-appliances-repair/refrigerator-repair-service/">refrigerator repair</a> service in Dubai.</p>
                <p className="mb-0"> <b> Candy Freezer Repair Near You in Dubai: </b> For Candy freezer repair and service in Dubai and Sharjah, our team of qualified technicians is available. </p>
                <p className="mb-0"> <b> Candy Home Appliance Service Center Near You: </b> If you are looking for the best repair service for Candy washer dryer in Dubai, FAJ is an excellent choice.
                  They are renowned for their outstanding service in repairing Candy fridge freezer and are recognized as the leading provider for the repair of Candy cooking ranges, stove fixes, induction, cooktop fixes, washing machines repair, and refrigerator repairs in the area.
                </p>
                <p className="mb-0"> <b> Candy Dishwasher Repair Near You in Dubai: </b> Your Candy dishwasher may need repair or maintenance. For high-quality integrated Candy <a href="https://www.fajservices.ae/services/home-appliances-repair/dishwasher-repair-service/">dishwasher repair</a> and service center in Dubai, rely on FAJ.</p>
                <p className="mb-0"> <b> Candy Cooking Range and Oven Repair Near You: </b> We offer expert repair services for Candy cooking ranges and ovens in Dubai. Our skilled technicians are knowledgeable and experienced in diagnosing and fixing issues with Candy refrigerators, dishwashers, dryers, and more. </p>
                <p className="mb-0"> <b> Candy Dryer Repair and Service Near You: </b> Are you worried about your Candy dryer not working properly? Looking for a reliable Candy laundry machine company in Dubai? Contact us for same-day service!</p>
                <p className="mb-0"> <b> Candy Oven Repair Near Me Dubai: </b>  If you are looking for the best company for Candy oven repairs in Dubai, FAJ is the perfect choice. They are well-known for providing exceptional service for Candy <a href="https://www.fajservices.ae/services/home-appliances-repair/oven-repair-service/">oven repairs</a>. FAJ is recognized as the leading service center for Candy ovens in the area.</p>

                <h4 className="mt-3">We offer service for Candy appliances in the Dubai area</h4>
                <p>
...
export default CandyRefrigeratorRepairDetail;
