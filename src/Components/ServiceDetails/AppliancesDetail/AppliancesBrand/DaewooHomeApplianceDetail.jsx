...
const DaewooHomeApplianceDetail = ({ subtitle, title, bgImg }) => {
    ...
    const description = "Daewoo appliances repair Dubai. We are experts in Daewoo refrigerator, fridge, washing machine, dishwasher, and oven fix repair near me Dubai.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.com/daewoo-home-appliances-repair/";
