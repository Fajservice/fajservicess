...
const DaewooHomeApplianceRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Daewoo Home Appliances Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
        "https://imagedelivery.net/7jVKF8FS0aEmjeSSRZqLyA/FajLogo1/public"
      ],
      "url": "https://www.fajservices.ae/services/home-appliances-repair/brands/daewoo/",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Daewoo Home Appliances Repair Services",
        "itemListElement": [
          {
            "@type": "OfferCatalog",
            "name": "Daewoo Appliances Services",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Washing Machine Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Fridge Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Freezer Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Home Appliance Service Center" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Dishwasher Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Cooking Range and Oven Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Dryer Repair and Service" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Daewoo Oven Repair" } }
            ]
          }
        ]
      },
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.fajservices.ae/services/home-appliances-repair/brands/daewoo/#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 5, "name": "Daewoo", "item": "https://www.fajservices.ae/services/home-appliances-repair/brands/daewoo/" }
      ]
    }
  ]
}
        ...
        const fetchData = async () => {
            try {
                const [faqsResponse, testimonialsResponse] = await Promise.all([
                    fetch(`${import.meta.env.BASE_URL}data/AppliancesData/AppliancesFaqs/DaewooAppliancesFaqs.json`),
...
{/* Best Home Appliance Service Center */}
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')} alt="Daewoo Fridge Repair" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
                    ...
                    <div className="container">
                        ...
                        <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">
                            ...
                            <div className="col-12 col-md-4 col-lg-3">
                                <div className=" box-content-container rounded border shadow">
                                    <div className="text-center">
                                        <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Daewoo Washing Machine
                                        </h3>
                                    </div>
                                    <div className="inner-apcs-feat-desc">
                ...
                <section className="section cs_py_30 ">
                    <div className="container">
                        <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Daewoo HOME APPLIANCES</h2>
                ...
                <section className="section cs_py_30 appliances-benifit-sec bg-dark-blue">
                    <div className="container">
                        <div className="row justify-content-center">
                            <h2 className="cs_fs_30 mb-0 text-light">The Benefits of Daewoo appliances Service Dubai
                            </h2>
