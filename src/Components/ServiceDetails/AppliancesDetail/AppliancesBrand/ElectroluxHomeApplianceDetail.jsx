...
const ElectroluxHomeApplianceDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
   <>
        <HelmetProvider>
          <title>Electrolux Home Appliance - Washing Machine Repair Dubai</title>
          <meta name="description" content="Electrolux Appliance Repair Dubai - We offer Electrolux Refrigerator, Electrolux Washing Machine, Dishwasher, Dryer, Oven, and Stove repair services."></meta>
        </HelmetProvider>
        <HeaderForm />
