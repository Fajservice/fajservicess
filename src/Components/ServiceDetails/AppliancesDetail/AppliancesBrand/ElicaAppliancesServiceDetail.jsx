...
const ElicaAppliancesServiceDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
    <HelmetProvider>
      <title>Indesit Fridge Repair - Indesit Washing Machine Service</title>
      <meta name="description" content="Indesit Fridge Repair Dubai - Get expert Indesit washing machine repair, refrigerator, cooker, oven dryer repair service near me. Dail 043300002"></meta>
    </HelmetProvider>
    <HeaderForm />
