...
const FaberAppliancesServiceDetail = ({ subtitle, title, bgImg }) => {
    ...
    const Keyword = "";
    const URL = "https://fajservices.com/faber-appliances-service/";
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h1 className="cs_fs_30">Faber Appliances Service</h1>
                        {/* 
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best Faber Washing Machine Repair </h3>

                                <p className="mb-2">
                                    If you need Faber Appliance Repair, FAJ is your best choice for fast and affordable service in Dubai and Sharjah.
                            ...
                            <div className="uspcol col-3">
                                <div className="uspitem">
                                    ...
                                    <div className="usptext">
                                        ...
                                        <p>We are experts in Faber appliance repair this is why most major brands trust us to handle their service and maintenance needs.</p>
                                    </div>
                                </div>
                                <div className="uspitem">
                                    <div className="uspicon">
