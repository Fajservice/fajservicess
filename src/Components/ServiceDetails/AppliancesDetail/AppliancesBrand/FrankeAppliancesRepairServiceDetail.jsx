...
const FrankeAppliancesRepairServiceDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Franke Appliances Repair – Dishwasher & Oven Services";
  const description = "Franke Appliances Repair Dubai. Get Best Franke fridge, refrigerator fix, washing machine, cooker, oven repair service near me in Dubai Call 043300002";
  const Keyword = "";
  const Author = "Faj Technical Servcies";
  const URL = "https://www.fajservices.com/franke-appliances-repair-service-in-dubai/";
