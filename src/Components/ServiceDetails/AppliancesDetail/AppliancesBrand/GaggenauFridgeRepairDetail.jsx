...
const GaggenauFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  const Keyword = "";
  const URL = "https://fajservices/gaggenau-fridge-repair-in-dubai-gaggenau-washing-machine-repair-in-dubai-gaggenau-cooker-repair-in-dubai-gaggenau-oven-repair-in-dubai-gaggenau-appliances-maintenance-in-dubai-gaggenau-refrigerator-fi/";
