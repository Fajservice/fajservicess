...
const GeGeneralElectricFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Top GE General Fridge Repair in Dubai - Washing Machine";
  const description = "FAJ offers GE General Electric Fridge Repair in Dubai. Best freezer, refrigerator, washing machine, dryer maintenance service. Call 043300002";
  const Keyword = "";
  const Author = "Faj Technical Servcies";
  const URL = "https://www.fajservices.com/ge-general-electric-fridge-repair-in-dubai-ge-general-electric-washing-machine-repair-in-dubai-ge-general-electric-cooker-repair-in-dubai-ge-general-electric-oven-repair-in-dubai-ge-general-electric-a/";
