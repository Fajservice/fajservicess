...
const GibsonFridgeRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  // For SEO
  const metatitle = String(titleSeo || "Gibson Fridge Repair in Dubai - Washer Dryer Maintenance");
  const metadescription = String(description || "Find Gibson Fridge fridge in Dubai. Book an 043300002 for Gibson appliances, refrigerator, freezer, washing machine, dryer fix service near me");
      ...
      <div className="cs_service_details">
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <h2 className="cs_fs_24 mb-1 pt-3 border-small-top">Fast and Reliable Gibson Appliances Service</h2>
                <p className="mb-2">
              ...
              <div className="col-md-6 ">
                ...
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/The-Most-Common-Reasons-for-Appliance-Breakdowns.avif`} loading="lazy" alt="Gibson Washing Machine Repair" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_30">Why is Gibson Appliance Maintenance Service Important in Dubai?</h3>
            <p className="mb-0">
              Our extensive repair services include diagnosis, repairs, installations, and maintenance. This positions us as the leading provider of Gibson appliance maintenance in Dubai.
            </p>

            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/dishwasher-repair-service.avif`} loading="lazy" alt="Gibson Washing Machine Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
                  <li><strong>  Gibson Washing Machine Repair in Dubai: </strong> Regular maintenance can prolong your Gibson washing machine's lifespan, saving you money. </li>
                  <li><strong>  Gibson Fridge Repair in Dubai: </strong> We are confident that we can quickly get your Gibson refrigerator up and running again. </li>
                  <li><strong>  Gibson Stove / Oven Repair in Dubai: </strong> Catching minor issues early can help prevent them from escalating into expensive repairs. </li>
                  <li><strong>  Gibson Dishwasher Repair in Dubai: </strong> Regular maintenance helps minimise potential problems and improves overall performance. </li>
                  ...
                  <li><strong>  Energy Efficiency: </strong> Regular maintenance of your Gibson appliances can enhance efficiency and save you money. </li>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">The Most Common Problems with Gibson Appliances </h3>
            <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">

              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Refrigerator</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Gibson refrigerator may have cooling problems, usually related to the defrost, motor, compressor, or PCB. Let's reach out to FAJ for potential solutions.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Dishwasher</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Common issues with Gibson dishwasher include poor cleaning and drying, water leaks, drainage issues, and a few electrical or PCB malfunctions.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Washing Machine</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Gibson washing machines include problems with drainage, leaks, faulty PCBs, and issues related to the belt, door switch, or drum spinning.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Tumble Dryer</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Gibson dryer may stop spinning and make unusual noises without properly drying clothes, often due to a faulty heating element or control board.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Cooker / Stove</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Common issues with Gibson stove include uneven heating and flame problems, such as a broken burner element, a faulty switch, or an electrical gas malfunction.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Oven</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Gibson ovens often experience issues such as improper heating, unignited burners, ignition problems in gas models, and faulty knobs or controls.</p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Gibson Freezer</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Common issues with Gibson freezer include water leaks, insufficient ice production, malfunctioning ice makers, and decreased cooling efficiency.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h2 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR Gibson APPLIANCES</h2>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                <p className='mb-0'>We specialize in all types of Gibson appliances, including built-in models.</p>
                <p className='mb-0'><strong>Our services include:</strong></p>
                <ul className="cs_list cs_style_ cs_fs_16 cs_mp_ mb-0">
                  <li> <strong> Gibson Appliance Installation: </strong> Expert installation of various types and brands of Gibson home appliances to ensure their optimal performance and efficiency. </li>
                  <li> <strong> Gibson Appliance Diagnostics: </strong> We offer expert diagnostics and eligibility assessments, along with detailed quotes for issues related to Gibson appliances. </li>
                  <li> <strong> Gibson Appliance Repair Service: </strong> We offer fast and effective repair service for Gibson appliances, quickly addressing leaks, electrical issues, and malfunctions. Contact us for details about specific services or any questions you may have! </li>
                  <li> <strong> Gibson Appliance Annual Maintenance Contract: </strong> This contract outlines the terms for the annual maintenance of your Gibson appliances, ensuring they function smoothly throughout the year. Enjoy peace of mind with professional care. </li>
                  <p className="mb-0">
                    <a href="https://www.linkedin.com/company/faj-technical-services-llc">Regular maintenance</a> is essential for keeping your Gibson home appliances operating efficiently, performing well, and lasting longer.
                  </p>
                </ul>
              </div>
        ...
        <section className="section cs_py_30 appliances-benifit-sec bg-light-gray">
          <div className="container">
            <div className="row justify-content-center">
              <h2 className="cs_fs_30 mb-0">The Benefits of Gibson Appliances Service Dubai</h2>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Regular maintenance helps your Gibson appliances run smoothly and efficiently, delivering the best results every time.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Energy-efficient Gibson appliances help you save on utility bills, allowing you to keep more money in your pocket each month.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Preventive services help identify issues early, reducing breakdowns and repairs while enhancing the lifespan of Gibson appliances.
                      </p>
                    </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Regular maintenance and prompt servicing can significantly prolong the lifespan of your Gibson appliances, delaying the need for replacements.
                      </p>
                    </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Keeping your Gibson appliances in good working order enhances your confidence and minimizes the stress of unexpected breakdowns.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem mb-0">
                  ...
                  <div className="usptext">
                    ...
                    <p>Schedule a day and time for your Gibson appliance repair in Dubai or Sharjah, allowing a 3-4 hour window for the technician's arrival.</p>
                  </div>
                </div>
              ...
              <div className="uspcol col-3">
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>We specialize in Gibson appliance repair, which is why major brands trust us to handle their service and maintenance needs.</p>
                  </div>
                </div>
                <div className="uspitem">
                  <div className="uspicon">
                  ...
                  <div className="usptext">
                    ...
                    <p>Inspection fee includes diagnosis, transport, and reinstallation up to two Gibson appliances at the same location in Dubai.</p>
                  </div>
                </div>
                <div className="uspitem mb-0">
                  <div className="uspicon">
                  ...
                  <div className="usptext">
                    ...
                    <p>Our skilled technicians specialise in Gibson appliances and provide outstanding service across major appliances.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30 bg-light-gray mb-4">
          <div className="container">
            <h3>We specialize in Gibson appliance services of the following types</h3>
            <div className="row">
              <div className="col-12">
                <p className="mb-0"> <b> Gibson Washing Machine Repair Near You in Dubai: </b> FAJ is here to support you when issues arise. We understand that your Gibson washing machine is vital for daily life, ensuring your laundry stays clean. Contact us for the best Gibson <a href="https://www.fajservices.ae/washing-machine-repair-service-dubai/">washing machine service center</a> near me in Dubai. </p>
                <p className="mb-0"> <b> Gibson Fridge Repair Near You in Dubai: </b> If you are having problems with your Gibson refrigerator, please contact the FAJ team for same-day Gibson <a href="https://www.fajservices.ae/refrigerator-repair-service/">refrigerator repair service</a> in Dubai. </p>
                <p className="mb-0"> <b> Gibson Freezer Repair Near You in Dubai: </b> Our team of qualified technicians is available for Gibson freezer repair and service in Dubai and Sharjah. </p>
                <p className="mb-0"> <b> Gibson Home Appliance Service Center Near You: </b> If you are seeking the best repair service Gibson washer dryer in Dubai, FAJ is an excellent choice. They are well-known for their exceptional service in repairing Gibson fridge freezer and are recognized as the leading provider for repairs of fix Gibson cooking range, stove fixes, induction cooktops, repair Gibson washing machines, and Gibson refrigerator in the area. </p>
...
export default GibsonFridgeRepairDetail;
