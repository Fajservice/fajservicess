...
const GibsoneFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          ...
          <h2 className="cs_fs_30">CHOOSE APPLIANCE SERVICE CENTER FOR SAME-DAY REPAIRS IN DUBAI</h2> */}
            <p>
              Gibsone appliances are the best among the other brands out there. Still, products of the best brands even do not last endlessly. In addition, we are all sure that our appliances break down when we need them the most. Reasonably, your first reaction will be to see if your appliance is repairable. You can fix minor issues, but mostly, you cannot. So why worry? We are the best Gibsone appliance repair service provider in Dubai. We are the most experienced industry experts serving since 2010 in Dubai. With hands-on experience with all home appliances, you can expect successful and swift repairs from us. Gibsone Fridge Repair in Dubai So, contact us today to get your repair appointment. Enjoy superior Gibsone appliance repair with FAJ Technical Services LLC.
            </p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best Gibsone Washing Machine Repair </h3>

                <p className="mb-2">
                  If you need Gibsone Appliance Repair, FAJ is your best choice for fast and affordable service in Dubai and Sharjah.
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h3 className="text-center">The Most Common Problems with Gibsone Home Appliances   </h3>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            ...
            <h3 className="cs_fs_30">Why is Gibsone Appliance Maintenance Service Important in Dubai?</h3>
            <p className="">
              Our all-inclusive repair services include diagnosis, repairs, installations, and maintenance. That is why we are the most in-demand Gibsone appliances maintenance in Dubai provider.
            </p>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <ul className="mb-0">
                  <li> <strong>  Gibsone Washing Machine Repair in Dubai:-: </strong> Regular maintenance helps appliances last longer, saving on replacement costs.</li>
                  <li> <strong>  Gibsone Fridge Repair in Dubai: </strong> we are fully confident of getting your fridge running back in no time. </li>
                  <li> <strong>  Gibsone Cooker Repair in Dubai: </strong> Catching minor issues early prevents them from escalating into expensive repair. </li>
        ...
        <section className="section cs_py_30 appliances-benifit-sec">
          <div className="container">
            <div className="row justify-content-center">
              <h3 className="cs_fs_30 mb-0">The Benefits Of Gibsone appliances Service Dubai
              </h3>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR Gibsone HOME APPLIANCES</h3>
              ...
              <div className="uspcol col-3">
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>We are experts in Gibsone appliance repair this is why most major brands trust us to handle their service and maintenance needs.</p>
                  </div>
                </div>
                <div className="uspitem">
                  <div className="uspicon">
...
export default GibsoneFridgeRepairDetail;
