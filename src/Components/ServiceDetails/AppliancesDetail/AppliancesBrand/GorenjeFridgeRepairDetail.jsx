...
const GorenjeFridgeRepairDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Gorenje Fridge Repair In Dubai - Washing Machine Service #1";
  const description = "Reliable & same-day Gorenje fridge repair in Dubai. Dail 043300002 for Gorenje washing machine, refrigerator, hob, oven, dishwasher service near me";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com//gorenje-fridge-repair-in-dubai-gorenje-washing-machine-repair-in-dubai-gorenje-cooker-repair-in-dubai-gorenje-oven-repair-in-dubai-gorenje-appliances-maintenance-in-dubai-gorenje-refrigerator-fix-repa/";
