...
const HisenseFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
    ...
    const Keyword = "";
    const URL = "https://www.fajservices.com/hisense-fridge-repair-in-dubai-hisense-washing-machine-repair-in-dubai-hisense-cooker-repair-in-dubai-hisense-oven-repair-in-dubai-hisense-appliances-maintenance-in-dubai-hisense-refrigerator-fix-repa/";
