...
const HooverFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
     <>
            <HelmetProvider>
                <title>Hoover Fridge Repair - Washing Machine Service Dubai</title>
                <meta name="description" content="Hoover Fridge Repair Dubai - Expert Hoover washing machine repairs, refrigerator, dishwaher, gas / electric cooker, oven, service near me 043300002"></meta>
            </HelmetProvider>
            <HeaderForm />
