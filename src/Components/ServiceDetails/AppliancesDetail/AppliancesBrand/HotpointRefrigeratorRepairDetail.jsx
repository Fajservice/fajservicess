...
const HotpointRefrigeratorRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/brands/hotpoint/").replace(/\/?$/, '/');
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Hotpoint Home Appliances Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
        "https://imagedelivery.net/7jVKF8FS0aEmjeSSRZqLyA/FajLogo1/public"
      ],
      "url": "https://www.fajservices.ae/services/home-appliances-repair/brands/hotpoint/",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Hotpoint Home Appliances Repair Services",
        "itemListElement": [
          {
            "@type": "OfferCatalog",
            "name": "Hotpoint Appliances Services",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Washing Machine Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Fridge Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Freezer Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Home Appliance Service Center" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Dishwasher Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Cooking Range and Oven Repair" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Dryer Repair and Service" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hotpoint Oven Repair" } }
            ]
          }
        ]
      },
      "review": [
        { "@type": "Review", "author": { "@type": "Person", "name": "Anusri Chan" }, "reviewBody": "Hotpoint washing machine repair completed efficiently. Technician ensured proper functioning and shared maintenance tips.", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" } },
        { "@type": "Review", "author": { "@type": "Person", "name": "Haris M" }, "reviewBody": "Hotpoint oven was repaired professionally. Technician Que handled the service quickly and thoroughly.", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" } },
        { "@type": "Review", "author": { "@type": "Person", "name": "Khurram Mahmood" }, "reviewBody": "Excellent Hotpoint refrigerator repair service. Technician was knowledgeable and resolved the issue without delay.", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" } },
        { "@type": "Review", "author": { "@type": "Person", "name": "Jason Miller" }, "reviewBody": "Hotpoint dishwasher repair was seamless. Team communicated well and delivered excellent results.", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" } },
        { "@type": "Review", "author": { "@type": "Person", "name": "Affu Affu" }, "reviewBody": "Highly recommend FAJ for Hotpoint appliance repairs. Reliable, professional, and efficient service from start to finish.", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" } }
      ]
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.fajservices.ae/services/home-appliances-repair/brands/hotpoint/#breadcrumb",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 5, "name": "Hotpoint", "item": "https://www.fajservices.ae/services/home-appliances-repair/brands/hotpoint/" }
      ]
    }
  ]
}
...
{/* Best Home Appliance Service Center */}
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <div className="row gx-md-5 align-items-center">
              ...
              <div className="col-md-6 ">
                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Hotpoint Washing Machine Repair" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h3 className="cs_fs_30">Why is Hotpoint Appliance Maintenance Service Important in Dubai?</h3>
            <p className="mb-0">
              Our extensive repair services include diagnosis, repairs, installations, and maintenance. This positions us as the leading provider of Hotpoint appliance maintenance in Dubai.
            </p>

            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Hotpoint Washing Machine Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
                  <li><strong>  Hotpoint Washing Machine Repair in Dubai: </strong> Regular maintenance can prolong your Hotpoint washing machine's lifespan, saving you money. </li>
                  <li><strong>  Hotpoint Fridge Repair in Dubai: </strong> We are confident that we can quickly get your Hotpoint refrigerator up and running again. </li>
                  <li><strong>  Hotpoint Stove / Oven Repair in Dubai: </strong> Catching minor issues early can help prevent them from escalating into expensive repairs. </li>
                  <li><strong>  Hotpoint Dishwasher Repair in Dubai: </strong> Regular maintenance helps minimise potential problems and improves overall performance. </li>
                  ...
                  <li><strong>  Energy Efficiency: </strong> Regular maintenance of your Hotpoint appliances can enhance efficiency and save you money. </li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <h3 className="text-center">The Most Common Problems with Hotpoint Appliances </h3>
            <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">

              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Refrigerator</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Hotpoint refrigerator may have cooling problems, usually related to the defrost, motor, compressor, or PCB. Let's reach out to FAJ for potential solutions.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Dishwasher</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Common issues with Hotpoint dishwasher include poor cleaning and drying, water leaks, drainage issues, and a few electrical or PCB malfunctions.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Washing Machine</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Hotpoint washing machines include problems with drainage, leaks, faulty PCBs, and issues related to the belt, door switch, or drum spinning.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Tumble Dryer</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Hotpoint dryer may stop spinning and make unusual noises without properly drying clothes, often due to a faulty heating element or control board.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Cooker / Stove</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Common issues with Hotpoint stove include uneven heating and flame problems, such as a broken burner element, a faulty switch, or an electrical gas malfunction.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Oven</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Hotpoint ovens often experience issues such as improper heating, unignited burners, ignition problems in gas models, and faulty knobs or controls.</p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_16 my-0 bg-dark-blue rounded-top text-light py-2 py-md-1 mt-0">Hotpoint Freezer</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">Common issues with Hotpoint freezer include water leaks, insufficient ice production, malfunctioning ice makers, and decreased cooling efficiency.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Hotpoint APPLIANCES</h2>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                <p className='mb-0'>We specialize in all types of Hotpoint appliances, including built-in models.</p>
                <p className='mb-0'><strong>Our services include:</strong></p>
                <ul className="cs_list cs_style_ cs_fs_16 cs_mp_ mb-0">
                  <li> <strong> Hotpoint Appliance Installation: </strong> Expert installation of various types and brands of Hotpoint home appliances to ensure their optimal performance and efficiency. </li>
                  <li> <strong> Hotpoint Appliance Diagnostics: </strong> We offer expert diagnostics and eligibility assessments, along with detailed quotes for issues related to Hotpoint appliances. </li>
                  <li> <strong> Hotpoint Appliance Repair Service: </strong> We offer fast and effective repair service for Hotpoint appliances, quickly addressing leaks, electrical issues, and malfunctions. Contact us for details about specific services or any questions you may have! </li>
                  <li> <strong> Hotpoint Appliance Annual Maintenance Contract: </strong> This contract outlines the terms for the annual maintenance of your Hotpoint appliances, ensuring they function smoothly throughout the year. Enjoy peace of mind with professional care. </li>
                  <p className="mb-0">
                    <a href="https://www.linkedin.com/company/faj-technical-services-llc">Regular maintenance</a> is essential for keeping your Hotpoint home appliances operating efficiently, performing well, and lasting longer.
                  </p>
                </ul>
              </div>
        ...
        <section className="section cs_py_30 appliances-benifit-sec bg-dark-blue">
          <div className="container">
            <div className="row justify-content-center">
              <h2 className="cs_fs_30 mb-0 text-light">The Benefits of Hotpoint Appliances Service Dubai</h2>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Regular maintenance helps your Hotpoint appliances run smoothly and efficiently, delivering the best results every time.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Energy-efficient Hotpoint appliances help you save on utility bills, allowing you to keep more money in your pocket each month.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Preventive services help identify issues early, reducing breakdowns and repairs while enhancing the lifespan of Hotpoint appliances.
                      </p>
                    </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Regular maintenance and prompt servicing can significantly prolong the lifespan of your Hotpoint appliances, delaying the need for replacements.
                      </p>
                    </div>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Keeping your Hotpoint appliances in good working order enhances your confidence and minimizes the stress of unexpected breakdowns.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem mb-0">
                  ...
                  <div className="usptext">
                    ...
                    <p>Schedule a day and time for your Hotpoint appliance repair in Dubai or Sharjah, allowing a 3-4 hour window for the technician's arrival.</p>
                  </div>
                </div>
              ...
              <div className="uspcol col-3">
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>We specialize in Hotpoint appliance repair, which is why major brands trust us to handle their service and maintenance needs.</p>
                  </div>
                </div>
                <div className="uspitem">
                  <div className="uspicon">
                  ...
                  <div className="usptext">
                    ...
                    <p>Inspection fee includes diagnosis, transport, and reinstallation up to two Hotpoint appliances at the same location in Dubai.</p>
                  </div>
                </div>
                <div className="uspitem mb-0">
                  <div className="uspicon">
                  ...
                  <div className="usptext">
                    ...
                    <p>Our skilled technicians specialise in Hotpoint appliances and provide outstanding service across major appliances.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section cs_py_30 bg-light-gray mb-4">
          <div className="container">
            <DaiganosisCharges
              appliancebrand="Hotpoint Appliance"
              feeRange="ranging from AED 157 to 280"
            />
            <h3>We specialize in Hotpoint appliance services of the following types</h3>
            <div className="row">
              <div className="col-12">
                <p className="mb-0"> <b> Hotpoint Washing Machine Repair Near You in Dubai: </b> FAJ is here to support you when issues arise. We understand that your Hotpoint washing machine is vital for daily life, ensuring your laundry stays clean. Contact us for the best Hotpoint <a href="https://www.fajservices.ae/services/home-appliances-repair/washing-machine-repair-service-dubai/">washing machine service center</a> near me in Dubai. </p>
                <p className="mb-0"> <b> Hotpoint Fridge Repair Near You in Dubai: </b> If you are having problems with your Hotpoint refrigerator, please contact the FAJ team for same-day Hotpoint <a href="https://www.fajservices.ae/services/home-appliances-repair/refrigerator-repair-service/">refrigerator repair service</a> in Dubai. </p>
                <p className="mb-0"> <b> Hotpoint Freezer Repair Near You in Dubai: </b> Our team of qualified technicians is available for Hotpoint freezer repair and service in Dubai and Sharjah. </p>
                <p className="mb-0"> <b> Hotpoint Home Appliance Service Center Near You: </b> If you are seeking the best repair service Hotpoint washer dryer in Dubai, FAJ is an excellent choice. They are well-known for their exceptional service in repairing Hotpoint fridge freezer and are recognized as the leading provider for repairs of fix Hotpoint cooking range, stove fixes, induction cooktops, repair Hotpoint washing machines, and Hotpoint refrigerator in the area. </p>
...
export default HotpointRefrigeratorRepairDetail;
