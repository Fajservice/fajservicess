...
const KitchenaidRefrigeratorRepairDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "KitchenAid Refrigerator Repair - Best Oven Repair Service";
  const description = "Kitchenaid Refrigerator Repair Dubai - Expert Kitchenaid freezer maintenance, washing machine, dishwasher, oven, and cooker repair services Dubai";
  const Keyword = "";
  const Author = "Faj Technical Servcies";
  const URL = "https://www.fajservices.com/kitchenaid-refrigerator-repair-in-dubai-fridge-repair-in-dubai-kitchenaid-freezer-maintenance-in-dubai-washing-machine-repair-in-dubai-dishwasher-kitchenaid-cooker-oven-repairs-fix-service-in-dubai/";
