...
const KitchenaidStandMixerRepairServiceDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "KitchenAid Stand Mixer Repair Services and Maintenance ";
  const description = "Kitchenaid Stand Mixer Repair Dubai - Professional Kitchenaid mixer repair, maintenance, and stand mixer servicing near you in Dubai. Dail 043300002";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/kitchenaid-stand-mixer-repair-service-near-me-dubai/";
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <h1 className="cs_fs_30">Kitchenaid StandMixer Repair Service</h1>
            {/* 
