...
const LgFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
            <HelmetProvider>
                <title>LG Fridge Repair - LG Washing Machine Repair | FAJ</title>
                <meta name="description" content="Get reliable LG washing machine repair in Dubai. we offer fridges, freezers, refrigerator, dishwashers, ovens & cooker repair and maintenance services"></meta>
            </HelmetProvider>
            <HeaderForm />
