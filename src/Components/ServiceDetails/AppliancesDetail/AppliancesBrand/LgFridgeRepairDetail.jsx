...
const LgFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "LG Fridge Repair - LG Washing Machine Repair | FAJ";
  const description = "Get reliable LG washing machine repair in Dubai. we offer fridges, freezers, refrigerator, dishwashers, ovens & cooker repair and maintenance services";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/lg-fridge-repair-in-dubai-lg-washing-machine-repair-in-dubai-lg-cooker-repair-in-dubai-lg-oven-repair-in-dubai-lg-appliances-maintenance-in-dubai-lg-refrigerator-fix-repairs-service-in-dubai-lg-dishwa/";
