...
const LiebherrRefrigeratorRepairDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Liebherr Refrigerator Repair Dubai - Fridge Service Near Me";
  const description = "With professional & reliable Liebherr refrigerator repair in Dubai. Dail 043300002 of your Liebherr appliance, fridge freezer maintenance service near me";
  const Keyword = "";
  const Author = "Faj Technical Servcies";
  const URL = "https://www.fajservices.com/liebherr-refrigerator-repair-in-dubai-liebherr-fridge-repair-in-dubai-liebherr-freezer-maintenance-service-in-dubai/";
