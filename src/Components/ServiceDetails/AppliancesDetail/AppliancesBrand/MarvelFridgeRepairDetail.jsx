...
const MarvelFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
    ...
    const Keyword = "";
    const URL = "https://fajservices.com/marvel-fridge-repair-in-dubai-marvel-washing-machine-repair-in-dubai-marvel-cooker-repair-in-dubai-marvel-oven-repair-in-dubai-marvel-appliances-maintenance-in-dubai-marvel-refrigerator-fix-repairs-se/";
