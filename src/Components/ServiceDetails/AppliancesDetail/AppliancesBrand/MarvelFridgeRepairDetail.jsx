...
const MarvelFridgeRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
    ...
    const metaURL = String(URL || "https://www.fajservices.ae/marvel-fridge-repair-in-dubai-marvel-washing-machine-repair-in-dubai-marvel-cooker-repair-in-dubai-marvel-oven-repair-in-dubai-marvel-appliances-maintenance-in-dubai-marvel-refrigerator-fix-repairs-se/").replace(/\/?$/, '/');
    ...
    return (
        <>
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30 bg-light-gray">
                    <div className="container">
                        <div className="row gx-md-5">
                            ...
                            <div className="col-md-6 ">
                                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/The-Most-Common-Reasons-for-Appliance-Breakdowns.avif`}  alt="Marvel Washing Machine Repair" />
                            </div>
                        </div>
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/dishwasher-repair-service.avif`}  alt="Marvel Washing Machine Repair" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h2 className="cs_fs_30">HERE ARE THE SERVICES WE OFFER FOR Marvel APPLIANCES</h2>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-12">
                                <p className="mb-0"> <b> Marvel Washing Machine Repair Near You in Dubai: </b> FAJ is here to support you when issues arise. We understand that your Marvel washing machine is vital for daily life, ensuring your laundry stays clean. Contact us for the best Marvel <a href="https://www.fajservices.ae/washing-machine-repair-service-dubai/">washing machine service center</a> near me in Dubai. </p>
                                <p className="mb-0"> <b> Marvel Fridge Repair Near You in Dubai: </b> If you are having problems with your Marvel refrigerator, please contact the FAJ team for same-day Marvel <a href="https://www.fajservices.ae/refrigerator-repair-service/">refrigerator repair service</a> in Dubai. </p>
