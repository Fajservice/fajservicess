...
const MaytagFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  const Keyword = "";
  const URL = "https://fajservices.com/maytag-fridge-repair-in-dubai-maytag-washing-machine-repair-in-dubai-maytag-cooker-repair-in-dubai-maytag-oven-repair-in-dubai-maytag-appliances-maintenance-in-dubai-maytag-refrigerator-fix-repairs-se/";
