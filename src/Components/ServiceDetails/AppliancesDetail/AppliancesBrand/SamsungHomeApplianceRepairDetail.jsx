...
const SamsungHomeApplianceRepairDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
      <>
            <HelmetProvider>
                <title>Samsung Appliances Repair - Samsung Refrigerator Service</title>
                <meta name="description" content="Trouble with your Samsung home appliances? FAJ provides Samsung washing machine, dryer, fridge, dishwasher service near me dubai. Dail 043300002"></meta>
            </HelmetProvider>
            <HeaderForm />
