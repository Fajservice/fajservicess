...
const SanyoHomeApplianceDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  // For SEO
  const metatitle = String(titleSeo || "Sanyo Home Appliances Service & Sanyo Fridge Repair Dubai");
  const metadescription = String(description || "If you're looking for the best Sanyo home appliances service in Dubai, call us for Sanyo washing machine, dishwasher, & oven repair centre near you.");
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/brands/sanyo/");
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Sanyo Home Appliances Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
        "https://imagedelivery.net/7jVKF8FS0aEmjeSSRZqLyA/FajLogo1/public"
      ],
      "url": "https://www.fajservices.ae/services/home-appliances-repair/brands/sanyo/",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.fajservices.ae/services/home-appliances-repair/brands/sanyo/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 5,
          "name": "Sanyo",
          "item": "https://www.fajservices.ae/services/home-appliances-repair/brands/sanyo/"
        }
      ]
    }
  ]
...
{/* Best Home Appliance Service Center */}
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Sanyo APPLIANCES</h2>
        ...
        <section className="section cs_py_30 appliances-benifit-sec bg-dark-blue">
          <div className="container">
            <div className="row justify-content-center">
              <h2 className="cs_fs_30 mb-0 text-light">The Benefits of Sanyo Appliances Service Dubai</h2>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>With a <Link to="/services/home-appliances-repair/appliances-amc-service/"> maintenance contract</Link>,  you get year-round service to keep your Sanyo appliance running smoothly and reliably.</p>
                  </div>
                </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-12">
                <p className="mb-0"> <b> Sanyo Washing Machine Repair Near You in Dubai: </b> FAJ is here to support you when issues arise. We understand that your Sanyo washing machine is vital for daily life, ensuring your laundry stays clean. Contact us for the best Sanyo <a href="https://www.fajservices.ae/services/home-appliances-repair/washing-machine-repair-service-dubai/">washing machine service center</a> near me in Dubai. </p>
                <p className="mb-0"> <b> Sanyo Fridge Repair Near You in Dubai: </b> If you are having problems with your Sanyo refrigerator, please contact the FAJ team for same-day Sanyo <a href="https://www.fajservices.ae/services/home-appliances-repair/refrigerator-repair-service/">refrigerator repair service</a> in Dubai. </p>
                ...
                <p className="mb-0"> <b> Sanyo Oven Repair Near Me Dubai: </b> If you're searching for the best company for Sanyo <a href="https://www.fajservices.ae/services/home-appliances-repair/oven-repair-service/">oven repair</a> in Dubai, FAJ is an excellent choice. They are renowned for providing exceptional service specifically for Sanyo ovens. FAJ is recognized as the leading service center for Sanyo oven repair and maintenance in Dubai. </p>
