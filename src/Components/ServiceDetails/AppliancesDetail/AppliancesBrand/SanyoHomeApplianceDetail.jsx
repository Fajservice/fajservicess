...
const SanyoHomeApplianceDetail = ({ subtitle, title, bgImg }) => {
  ...
  return (
     <>
        <HelmetProvider>
          <title>Sanyo Home Appliance Service - Sayno Refrigerator Repair</title>
          <meta name="description" content="If you're searching for reliable Sanyo fridge repair in Dubai. Call-FAJ 043300002 for Sanyo washing machine, dishwasher oven fix service nearme"></meta>
        </HelmetProvider>
        <HeaderForm />
