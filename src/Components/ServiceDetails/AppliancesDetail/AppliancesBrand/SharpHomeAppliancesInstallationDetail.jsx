...
const SharpHomeAppliancesInstallationDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
    // For SEO
    const metatitle = String(titleSeo || "Sharp Home Appliance Service | Sharp Refrigerator Repair Dubai");
    const metadescription = String(description || "Trusted Sharp home appliances service in Dubai. Call FAJ for Sharp washing machine, dryers, fridge, oven, and vacuum cleaner repair center near me");
