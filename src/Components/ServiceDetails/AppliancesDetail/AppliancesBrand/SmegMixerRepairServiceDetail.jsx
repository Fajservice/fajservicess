...
const SmegMixerRepairServiceDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Smeg Mixer Repair Service – Small Appliance Fix in Dubai";
  const description = "Book an expert Smeg mixer repair Dubai. Our trained team fix Retro Style Quart, Food Processor, Vintage & Dolce Mixer service near you. 043300002";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/smeg-mixer-repair-service-near-me-dubai/";
