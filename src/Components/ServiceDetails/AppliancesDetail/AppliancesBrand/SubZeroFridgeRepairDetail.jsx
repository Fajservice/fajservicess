...
const SubZeroFridgeRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/brands/sub-zero/");
  ...
  return (
    <>
      ...
      <div className="cs_service_details">
        ...
        <PriceCardHomeCat services={subzeroServicesData} />
          ...
          <div className="container">
            <div className="row gx-md-5 align-items-center">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  Is your Sub Zero fridge or freezer not cooling properly? Has your food spoiled?
                  <br />
                  You can easily book Sub Zero fridge and freezer repair services online with FAJ Experts in Dubai and Sharjah. We offer same-day repairs for Sub Zero refrigerators and freezers at affordable prices. Choose a convenient time slot that works best for you!

                </p>

                <h3 className="cs_fs_24 mb-1 pt-3 border-small-top" style={{ fontSize: "21px" }}>Fast and Reliable Sub Zero Appliances Service</h3>
                <p className="mb-2">
                  At FAJ Technical Services L.L.C, we understand that appliance breakdowns, especially with Sub Zero products, never occur at a convenient time. That’s why our trained and qualified Sub Zero technicians are here to offer you reliable <a href="https://www.fajservices.ae/services/home-appliances-repair/appliances-repair-service/">appliance repair services</a>. With our assistance, you can avoid the cost of purchasing a new appliance and get your Sub Zero appliance up and running again before you have a chance to worry about it.
                </p>

              </div>

              <div className="col-md-6">
                <img className="bordered-img w-100" src={getImageSrc('fridgerepair')} alt="Sub Zero Fridge repair" />
              </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <ul className="mb-0">
                  <li> <strong>  Sub Zero Refrigerator Extended Lifespan: </strong> Regular maintenance extends refrigerator life, saving you money on replacement costs. </li>
                  ...
                  <li> <strong>  Sub Zero Refrigerator Cost-Effectiveness: </strong> Maintenance costs are usually lower than early replacements or major repairs. Investing in refrigerator care in Dubai ensures safety and efficiency. </li>
                  <li> <strong>  Sub Zero Refrigerator Energy Efficiency: </strong> Routine maintenance can boost your Fridge’s energy efficiency, helping you save money in the long run. </li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                ...
                <ul className="cs_list cs_style_ cs_fs_16 cs_mp_ mb-0">
                  ...
                  <li> <strong> Sub Zero Refrigerator Diagnostics: </strong> We perform comprehensive diagnostics to effectively identify issues. Additionally, we offer eligibility assessments and detailed quotes to address any concerns regarding your system. </li>
                  <li> <strong> Sub Zero Refrigerator Repair Service: </strong> Prompt and effective repair services for all fridge freezer components, addressing issues like leaks, electrical failures, and system malfunctions. </li>
                  <li> <strong> Sub Zero Refrigerator Annual Maintenance Contract: </strong> This contract details the terms and services included in the annual maintenance of your refrigerator. </li>
                ...
                <div className="col-md-4 mb-2">
                  <div className="">
                    <div className="benifit-box-container">
                      ...
                      <p className="small">
                        Energy efficient refrigerator translates to monthly savings on utility bills, putting more money back in your pocket.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="section cs_py_30 bg-light-gray mb-4">
          <div className="container">
            <DaiganosisCharges
              appliancebrand="Sub Zero Appliance"
