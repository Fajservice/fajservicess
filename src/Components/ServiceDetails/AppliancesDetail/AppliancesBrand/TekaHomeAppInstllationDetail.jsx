...
const TekaHomeAppInstllationDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Best Teka Home Appliance Service - Teka Refrigerator Repair";
  const description = "FAJ offers same day Teka home appliance service. Dail 043300002 for Teka washing machine, fridge, dryer, oven, cooker, stove dishwasher repair near me";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/teka-home-appliance-installation-maintenance-repair-fix-service-in-dubai/";
