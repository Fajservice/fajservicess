...
const TekaHomeAppInstllationDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/brands/teka/");
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Teka Home Appliances Repair Services in Dubai - FAJ Technical Services L.L.C",
      "image": [
        "https://imagedelivery.net/7jVKF8FS0aEmjeSSRZqLyA/FajLogo1/public"
      ],
      "url": "https://www.fajservices.ae/services/home-appliances-repair/brands/teka/",
        ...
        "itemListElement": [
          {
            ...
            "itemListElement": [
              ...
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Cooker Repair" }
              },
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Hood & Hob Repair" }
              }
            ]
          }
        ]
      ...
      "review": [
        {
          ...
          "reviewBody": "The oven repair was completed successfully. The appliance now works perfectly and the service was smooth and professional.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5"
        ...
        },
        {
          ...
          "reviewBody": "Highly recommended service. They fixed my dishwasher efficiently and also provide washing machine and fridge repair services.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5"
        ...
        },
        {
          ...
          "reviewBody": "Professional and quick service for my cooker repair. Technicians were knowledgeable and ensured everything was working properly.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5"
        ...
        },
        {
          ...
          "reviewBody": "Friendly and efficient service. FAJ Technical Services L.L.C diagnosed the hob and hood issue quickly and fixed it without delay.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5"
        ...
        },
        {
          ...
          "reviewBody": "Excellent experience with FAJ Technical Services L.L.C for appliance repair. The technician was experienced and resolved the issue quickly.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5"
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.fajservices.ae/services/home-appliances-repair/brands/teka/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 5,
          "name": "Teka",
          "item": "https://www.fajservices.ae/services/home-appliances-repair/brands/teka/"
        }
      ]
    }
  ]
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Top-Quality Teka Home Appliances Repair Center and Service</h1>
...
{/* Best Home Appliance Service Center */}
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Teka Washing Machine Repair" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h2 className="cs_fs_30 text-uppercase">HERE ARE THE SERVICES WE OFFER FOR Teka APPLIANCES</h2>
        ...
        <section className="section cs_py_30 appliances-benifit-sec bg-dark-blue">
          <div className="container">
            <div className="row justify-content-center">
              <h2 className="cs_fs_30 mb-0 text-light">The Benefits of Teka Appliances Service Dubai</h2>
              ...
              <div className="uspcol col-1">
                ...
                <div className="uspitem">
                  ...
                  <div className="usptext">
                    ...
                    <p>With a <Link to="/services/home-appliances-repair/appliances-amc-service/"> maintenance contract</Link>,  you get year-round service to keep your Teka appliance running smoothly and reliably.</p>
                  </div>
                </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-12">
                <p className="mb-0"> <b> Teka Washing Machine Repair Near You in Dubai: </b> FAJ is here to support you when issues arise. We understand that your Teka washing machine is vital for daily life, ensuring your laundry stays clean. Contact us for the best Teka <a href="https://www.fajservices.ae/services/home-appliances-repair/washing-machine-repair-service-dubai/">washing machine service center</a> near me in Dubai. </p>
                <p className="mb-0"> <b> Teka Fridge Repair Near You in Dubai: </b> If you are having problems with your Teka refrigerator, please contact the FAJ team for same-day Teka <a href="https://www.fajservices.ae/services/home-appliances-repair/refrigerator-repair-service/">refrigerator repair service</a> in Dubai. </p>
                ...
                <p className="mb-0"> <b> Teka Oven Repair Near Me Dubai: </b> If you're searching for the best company for Teka <a href="https://www.fajservices.ae/services/home-appliances-repair/oven-repair-service/">oven repair</a> in Dubai, FAJ is an excellent choice. They are renowned for providing exceptional service specifically for Teka ovens. FAJ is recognized as the leading service center for Teka oven repair and maintenance in Dubai. </p>
