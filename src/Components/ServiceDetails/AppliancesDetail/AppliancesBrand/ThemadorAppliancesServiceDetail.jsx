...
const ThemadorAppliancesServiceDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Thermador Appliances Service Dubai #1 Thermador Oven Repair";
  const description = "Call our trained team by dialling 043300002 for Thermador Appliances Service Dubai and cooking range, oven, fridge repair & maintenance near me";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.com/thermador-appliances-service/";
