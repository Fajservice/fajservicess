...
const WestpointFridgeRepairDetail = ({ subtitle, title, bgImg }) => {
  // For SEO
  const titleSeo = "Westpoint Fridge Repair – Expert Washing Machine Service";
  const description = "FAJ Specialize in Westpoint fridge repair in Dubai, Get same day washing machine, dishwasher, oven, cooking range repair services near me. 043300002";
  const Keyword = "";
  const Author = "Faj Technical Servcies";
  const URL = "https://www.fajservices.com/westpoint-fridge-repair-in-dubai-westpoint-washing-machine-repair-in-dubai-westpoint-cooker-repair-in-dubai-westpoint-oven-repair-in-dubai-westpoint-refrigerator-fix-repairs-service-in-dubai-west-poin/";
