...
const WolfHomeAppMaintenanceDetail = ({ subtitle, title, bgImg }) => {
  ...
  const Keyword = "";
  const URL = "https://www.fajservices.com/wolf-home-appliance-installation-maintenance-repair-fix-service-in-dubai/";
