...
const ApplianceServiceInAcademyCityDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Academy City - Fridge Repair Dubai";
    const description = "FAJ offers best appliance services in Academy City. Get washing machine repair near me in Dubai. Call 043300002 for fridge, dishwasher, and oven fix.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-academy-city";
...
export default ApplianceServiceInAcademyCityDetail
