...
const ApplianceServiceInAlWahaCommunityDetail = ({ subtitle, title, bgImg }) => {
    ...
    const description = "We offer best appliance services in Waha Community. Get fridge repair near me in Dubai. Book 043300002 for oven & washing machine maintenance";
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h2 className="cs_fs_30">Home Appliance Service in The Villa</h2>
