...
const ApplianceServiceInAlbarariDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliance Service in Al Barari - Refrigerator Repair Dubai";
    const description = "FAJ offers best appliance service in Al Barari. Get washing machine repair near me in Dubai. Call 043300002 for fridge, dishwasher, and oven fix.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-al-barari";
