...
const ApplianceServiceInArabianRanchesDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Service in Arabian Ranches - Fridge Repair Dubai";
    const description = "Same-day appliance services in Arabian Ranches. FAJ offers washing machine repair near me in Dubai. Book 043300002 for fridge, oven, dishwasher fix";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-arabian-ranches";
