...
const ApplianceServiceInArabianRanchesDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
    ...
    const metaURL = String(URL || "https://www.fajservices.ae/services/Home-appliances-repair/coverage-area/arabian-ranches/");
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in Arabian Ranches" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
