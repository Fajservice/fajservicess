...
const ApplianceServiceInCedreVillasSiliconOasisDubaiDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Cedre Villas Silicon Oasis Dubai";
    const description = "FAJ provides appliance services in Cedre Villas, Silicon Oasis, Dubai. Get fast washing machine repair & maintenance near me. Book 043300002 ";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-cedre-villas-silicon-oasis-dubai";
