...
const ApplianceServiceInDifcDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
    // For SEO
    const metatitle = String(titleSeo || "Best Appliances Service and Washing Machine Repair in DIFC");
    const metadescription = String(description || "We offer the best appliance services in DIFC, Dubai. Get washing machine & fridge repair near you. Book now for dishwasher, oven, and dryer maintenance");
    ...
    const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/coverage-area/difc/");
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h1 className="cs_fs_30">Same-Day Home Appliances Repair and Maintenance Service in DIFC, Dubai</h1>
                        <p>
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2">
                                    If you need appliance repair, FAJ is your best choice for fast and affordable service in Difc Dubai and Sharjah.
                            ...
                            <div className="col-md-6 ">
                                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Washing machine repair in Difc" />
                            </div>
                        </div>
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in Difc" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
...
export default ApplianceServiceInDifcDetail
