...
const ApplianceServiceInDifcDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Best Appliances Services in DIFC- Washing Machine Repair";
    const description = "We offer best appliance services in DIFC. Get washing machine repair near me in Dubai. Book 043300002 for fridge, oven, dishwasher maintenance";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-difc/";
