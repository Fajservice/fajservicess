...
const ApplianceServiceInDipDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Best Appliances Services in DIP - Fridge Repair Near Me";
    const description = "FAJ offers appliance service in DIP. Call 043300002 for fridge repair near me in Dubai. Get to fix washing machine, refrigerator, vacuum cleaner";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-dip";
                           ...
                           <div className="cs_service_details">
                               ...
                               <section className="section cs_py_30">
                                   <div className="container">
                                       <h2 className="cs_fs_30">Home Appliance Service in Dip</h2>
