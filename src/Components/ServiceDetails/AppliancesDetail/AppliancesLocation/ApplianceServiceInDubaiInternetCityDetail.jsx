...
const ApplianceServiceInDubaiInternetCityDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Dubai Internet City -Fridge Repair";
    const description = "FAJ offers best appliance service in Dubai Internet City. Get washing machine repair near me. Call 043300002 for dishwasher, oven and fridge fix.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-dubai-internet-city";
