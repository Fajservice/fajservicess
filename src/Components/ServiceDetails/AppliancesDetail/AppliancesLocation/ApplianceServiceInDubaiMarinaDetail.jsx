...
const ApplianceServiceInDubaiMarinaDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
    ...
    const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/coverage-area/dubai-marina/");
    ...
    return (
        <>
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30 appliances-benifit-sec bg-light-gray bg-light-gray">
                    <div className="container">
...
export default ApplianceServiceInDubaiMarinaDetail
