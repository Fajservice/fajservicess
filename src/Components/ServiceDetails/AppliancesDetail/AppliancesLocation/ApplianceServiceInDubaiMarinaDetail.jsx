...
const ApplianceServiceInDubaiMarinaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Dubai Marina - Refrigerator Repair";
    const description = "We offer best appliance Dubai Marina. Get washing machine repair near me in Dubai. Book 043300002 for fridge, oven, dishwasher maintenance";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-dubai-marina";
