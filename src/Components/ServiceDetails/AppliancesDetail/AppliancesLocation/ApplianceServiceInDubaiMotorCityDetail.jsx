...
const ApplianceServiceInDubaiMotorCityDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services In Dubai Motor City - Fridge Repair";
    const description = "Best Appliances Services in Dubai Motor City. Get Washing Machine Repair Near me Call at  043300002. Fix Refrigerator, Oven, Dishwasher Maintenance.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-dubai-motor-city";
