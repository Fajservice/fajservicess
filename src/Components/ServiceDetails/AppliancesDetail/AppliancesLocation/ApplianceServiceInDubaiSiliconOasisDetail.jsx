...
const ApplianceServiceInDubaiSiliconOasisDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Dubai Silicon Oasis - Fridge Repair";
    const description = "Same-day appliance service in Dubai Silicon Oasis. Get refrigerator repair near me. Call 043300002 to fix washing machine, dishwasher, fridge, and oven.";
     const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-dubai-silicon-oasis";
