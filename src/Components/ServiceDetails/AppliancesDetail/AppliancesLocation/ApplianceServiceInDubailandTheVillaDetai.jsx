...
const ApplianceServiceInDubailandTheVillaDetai = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Dubailand The Villa - Fridge Repair";
    const description = "Best appliance services in Dubailand the Villa. FAJ offers fridge repair near me. Call 043300002 for dishwasher, oven, washing machine maintenance";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-dubailand-the-villa";
