...
const ApplianceServiceInHudaibaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Hudaiba - Washing Machine Repair";
    const description = "Looking for appliance service in Hudaiba. Call 043300002 for fridge repair near me in Dubai. Get fix washing machine, dishwasher, refrigerator";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-hudaiba/";
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best Home Appliance Service in Hudaiba</h3>
