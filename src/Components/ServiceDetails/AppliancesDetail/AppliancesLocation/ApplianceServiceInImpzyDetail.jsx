...
const ApplianceServiceInImpzyDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in IMPZ - Washing Machine Repair Dubai";
    const description = "We offer best appliance services in IMPZ. Get fridge repair near me in Dubai. Book 043300002 for oven, dishwasher, washing machine maintenance";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-impzy";
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h1 className="cs_fs_30">Home Appliance Service in Impzy</h1>
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                <h3 className="cs_fs_24 mb-1">Best Home Appliance Service in IMPZ</h3>

                                <p className="mb-2">
                                    If you need appliance repair, FAJ is your best choice for fast and affordable service in IMPZ Dubai and Sharjah.
