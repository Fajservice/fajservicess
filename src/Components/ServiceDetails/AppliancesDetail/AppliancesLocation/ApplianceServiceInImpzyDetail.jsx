...
const ApplianceServiceInImpzyDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2">
                                    If you need appliance repair, FAJ is your best choice for fast and affordable service in Impzy Dubai and Sharjah.
                            ...
                            <div className="col-md-6 ">
                                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/The-Most-Common-Reasons-for-Appliance-Breakdowns.avif`} loading="lazy" alt="Washing machine repair in Impzy" />
                            </div>
                        </div>
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/dishwasher-repair-service.avif`} loading="lazy" alt="Refrigerator Repair in Impzy" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
