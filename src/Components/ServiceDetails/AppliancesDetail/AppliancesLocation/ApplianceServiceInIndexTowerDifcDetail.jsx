...
const ApplianceServiceInIndexTowerDifcDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Index Tower DIFC - Fridge Repair";
    const description = "Best appliance services in Index Tower DIFC. FAJ offers fridge repair near me. Call 043300002 for dishwasher, oven, washing machine maintenance";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-index-tower-difc/";
