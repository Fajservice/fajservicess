...
const ApplianceServiceInJbrDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in JBR - Refrigerator Repair Near Me";
    const description = "Appliance services in JBR, Dubai. Experts in refrigerator repair near me. Contact 043300002 to fix washing machine, oven & dishwasher";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jbr";
