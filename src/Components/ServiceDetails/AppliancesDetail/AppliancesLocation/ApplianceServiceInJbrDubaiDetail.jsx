...
const ApplianceServiceInJbrDubaiDetail = ({ subtitle, title, bgImg }) => {
    ...
    // For SEO
    const titleSeo = "Appliances Washing Machine Fridge Dishwasher Service JBR";
    const description = "Same-day appliances services in JBR. Get refrigerator repair near me in Dubai. Call 043300002 to fix washing machine, dishwasher & fridge";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-washing-machine-fridge-dishwasher-service-jbr-dubai";
