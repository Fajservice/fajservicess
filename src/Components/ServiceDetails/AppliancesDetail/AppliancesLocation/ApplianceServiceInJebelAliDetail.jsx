...
const ApplianceServiceInJebelAliDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Jebel Ali - Refrigerator Repair ";
    const description = "Faj offers appliance service in Jebel Ali . Call 043300002 for refrigerator repair near me in Dubai. Get fix washing machine, coffee machine";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jebel-ali";
