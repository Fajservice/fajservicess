...
const ApplianceServiceInJgeDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in JGE - Washing Machine Repair Near me";
    const description = "Looking for appliance service in JGE. Call 043300002 for fridge repair near me in Dubai. Get fix washing machine, dishwasher, refrigerator";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jge";
                               ...
                               <div className="container">
                                   <div className="row gx-md-5">
                                       <div className="col-md-6">
                                           <h3 className="cs_fs_24 mb-1">Best Home Appliance Service in JGE</h3>
