...
const ApplianceServiceInJumeirahVillageTriangleDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Best Appliances Services in Jumeirah Village Triangle";
    const description = "Looking appliance service in Jumeirah Village Triangle in Dubai. FAJ provide refrigerator repair near me, washing machine & more. Call now 043300002 ";
     const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jumeirah-village-triangle/";
