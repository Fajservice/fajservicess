...
const ApplianceServiceInJumeriahDubaiDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Home Appliances Service in Jumeirah - Washing Machine Repair";
    const description = "FAJ offering home appliances service in Jumeirah. Book an 043300002 for Siemens, Bosch, Daewoo, Electrolux, Teka refrigerator, fridge, oven repair.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/home-appliances-installation-maintenance-repair-fix-service-centre-in-jumeirah-dubai";
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2">
                                    If you need appliance repair, FAJ is your best choice for fast and affordable service in Jumeriah Dubai and Sharjah.
