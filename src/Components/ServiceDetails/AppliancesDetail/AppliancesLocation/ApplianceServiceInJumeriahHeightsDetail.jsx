...
const ApplianceServiceInJumeriahHeightsDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Jumeirah Heights - Fridge Repair";
    const description = "Get appliance services in Jumeirah Heights. FAJ offers fridge repair near me in Dubai. Call 043300002 for dishwasher, oven, washing machine.";
     const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jumeirah-heights";
