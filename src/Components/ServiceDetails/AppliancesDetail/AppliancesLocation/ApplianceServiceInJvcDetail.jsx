...
const ApplianceServiceInJvcDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Best Appliances Services In JVC Jumeirah Village Circle";
    const description = "Need appliance Services in JVC. We provide refrigerator repair near me, fridge, fix washing machine, dryer, cooker oven & more. Call us now  043300002";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jvc/";
                               ...
                               <div className="container">
                                   <div className="row gx-md-5">
                                       <div className="col-md-6">
                                           ...
                                           <p className="mb-2">
                                               If you need appliance repair, FAJ is your best choice for fast and affordable service in JVC Dubai and Sharjah.
...
export default ApplianceServiceInJvcDetail
