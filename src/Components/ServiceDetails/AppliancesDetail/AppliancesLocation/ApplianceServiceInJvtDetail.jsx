...
const ApplianceServiceInJvtDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services In JVT - Washing Machine Repair ";
    const description = "Looking for appliance Services in JVT. Call now 043300002 for refrigerator repair near me, fridge, fix washing machine, dishwasher, oven & more.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jvt/";
