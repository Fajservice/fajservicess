...
const ApplianceServiceInLayanComminityDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Layan Community - Fridge Repair ";
    const description = "FAJ offers appliance Services in Layan community. Call now at 043300002  for refrigerator, washing machine repair near me, washer dryer & more fix ";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-layan-community";
                       ...
                       <div className="cs_service_details">
                           ...
                           <section className="section cs_py_30">
                               <div className="container">
                                   <h1 className="cs_fs_30">Home Appliance Service in Layan Community</h1>
                                   {/* <h2 className="cs_fs_30">Home Appliance Service in Layan Community</h2> */}
                                   <p>
