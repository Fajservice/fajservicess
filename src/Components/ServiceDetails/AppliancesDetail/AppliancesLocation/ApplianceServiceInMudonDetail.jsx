...
const ApplianceServiceInMudonDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services In Mudon - Fridge Repair Dubai";
    const description = "FAJ offers appliances services in Mudon. Looking for refrigerator, fridge, washing machine repair and oven fix in Dubai near me. Call at 043300002.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-mudon";
...
export default ApplianceServiceInMudonDetail
