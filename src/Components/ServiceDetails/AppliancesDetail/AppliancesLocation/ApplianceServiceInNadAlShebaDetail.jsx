...
const ApplianceServiceInNadAlShebaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Nad Al Sheba - Refrigerator Repair";
    const description = "Get best appliance services in Nad Al Sheba. Experts in fridge repair near me in Dubai. Call 043300002 for washing machine, oven & dishwasher fix";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-nad-al-sheba";
