...
const ApplianceServiceInOudMethaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Oud Metha - Washing Machine Repair";
    const description = "FAJ offers best appliance services in Oud Metha. Get washing machine repair near me in Dubai. Call 043300002 for fridge, dishwasher, and oven fix.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-oud-metha";
