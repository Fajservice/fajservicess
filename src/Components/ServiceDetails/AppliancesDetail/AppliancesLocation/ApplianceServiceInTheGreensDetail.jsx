...
const ApplianceServiceInTheGreensDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in The Greens - Washing Machine Repair";
    const description = "Need appliances services in The Greens? FAJ offers refrigerator, washing machine, fridge repair and oven fix in dubai near me. Contact us 043300002 now.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-the-greens";
