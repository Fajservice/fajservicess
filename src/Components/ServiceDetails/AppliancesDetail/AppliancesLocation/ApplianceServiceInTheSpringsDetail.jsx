...
const ApplianceServiceInTheSpringsDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in The Springs - Fridge Repair Dubai";
    const description = "Get best appliance services in The Springs. Experts in fridge repair near me in Dubai. Call 043300002 for fix washing machine, oven, coffee machine";
