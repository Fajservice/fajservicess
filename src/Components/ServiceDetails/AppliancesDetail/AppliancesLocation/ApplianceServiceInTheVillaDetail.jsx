...
const ApplianceServiceInTheVillaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in The Villa - Washing Machine Repair";
    const description = "Looking for appliance service in The Villa. Call 043300002 for fridge repair near me in Dubai. Get fix washing machine, dishwasher, refrigerator";
