...
const ApplianceServiceInUmmAlSheifDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Umm Al Sheif - Fridge Repair Dubai";
    const description = "FAJ provides appliance services in Umm Al Sheif. Get fast fridge, dishwasher & washing machine repair near me in Dubai. Call us 043300002.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-umm-al-sheif";
