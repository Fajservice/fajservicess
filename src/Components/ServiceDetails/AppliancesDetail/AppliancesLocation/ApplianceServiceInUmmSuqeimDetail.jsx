...
const ApplianceServiceInUmmSuqeimDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services In Umm Suqeim - Refrigerator Repair";
    const description = "Best appliance services in Umm Suqeim. FAJ specializes in fridge repair near me in Dubai. Call 043300002 for reliable washing machine & oven fix.";
...
export default ApplianceServiceInUmmSuqeimDetail
