...
const AppliancesServiceInAlGhadeerCommunityDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Al Ghadeer Community - Fridge Repair";
    const description = "Faj offers appliance service in Al Ghadeer Community. Call 043300002 for refrigerator repair near me in Dubai. Get fix washing machine, Coffee machine";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-al-ghadeer-community/";
