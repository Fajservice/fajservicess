...
const AppliancesServiceInAlMamzarDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  // For SEO
  const metatitle = String(titleSeo || "Appliances Services In Al Mamzar - Washing Machine Repair");
  const metadescription = String(description || "Get appliance services in Al Mamzar. FAJ Experts refrigerator repair near me in Dubai. Call 043300002 to fix washing machine, fridge, dishwasher, oven");
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/appliances-services-in-al-mamzar/").replace(/\/?$/, '/');
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Home Appliance Service in Al Mamzar</h1>
            <p>
        ...
        <section className="section cs_py_30 bg-light-gray">
          <div className="container">
            <div className="row gx-md-5">
              ...
              <div className="col-md-6 ">
                <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/The-Most-Common-Reasons-for-Appliance-Breakdowns.avif`} loading="lazy" alt="Washing machine repair in Al Mamzar" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/dishwasher-repair-service.avif`} loading="lazy" alt="Refrigerator Repair in Al Mamzar" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
