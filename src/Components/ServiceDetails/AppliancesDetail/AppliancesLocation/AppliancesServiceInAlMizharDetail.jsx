...
const AppliancesServiceInAlMizharDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Appliances Services In Al Mizhar - Washing Machine Repair";
  const description = "Get appliance services in Al Mizhar. FAJ experts refrigerator repair near me in Dubai. Call 043300002 to fix washing machine, fridge, dishwasher, oven";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/appliances-services-in-al-mizhar";
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                <h3 className="cs_fs_24 mb-1">Best Home Appliance Service in Al Mizhar</h3>
