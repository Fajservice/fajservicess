...
const AppliancesServiceInBusinessBayDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Business Bay - Washing Machine Repair";
    const description = "Get the best appliance services in Business Bay. Experts in fridge repair near me in Dubai. Call 043300002 for washing machine, oven & dishwasher fix";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-business-bay";
                ...
                <div className="cs_service_details">
                    ...
                    <section className="section cs_py_30">
                        ...
                        <h1 className="cs_fs_30">Home Appliance Service in Business Bay</h1>
                            {/* <h2 className="cs_fs_30">CHOOSE APPLIANCE SERVICE CENTER FOR SAME-DAY REPAIRS IN DUBAI Business Bay</h2> */}
                            <p>
                        ...
                        <div className="container">
                            <div className="row gx-md-5">
                                <div className="col-md-6">
                                    <h3 className="cs_fs_24 mb-1">Best Home Appliance Service in Dubai Business Bay</h3>
