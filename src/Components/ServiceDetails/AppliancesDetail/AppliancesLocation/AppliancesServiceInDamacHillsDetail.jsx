...
const AppliancesServiceInDamacHillsDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metaKeyword = String(Keyword || "Washing Machine & Fridge Repair in  Damac Hills Dubai – Home Appliance Installation, Maintenance & Service Centre in Damac Hills Dubai");
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        <div className="acsvs-sec-prefoot-sec-ctwo">
                          ...
                          <img className="" src={`${import.meta.env.BASE_URL}img/benafit-acimg.jpg`} loading="lazy" alt="Post Image" />
                        </div>
                      </div>
                      <div className="col-lg-4">
