...
const AppliancesServiceInDubaiHillsEstateDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Appliances Services In Dubai Hills Estate - Washing Machine Repair";
  const description = "Get appliance services in Dubai Hills Estate. FAJ experts refrigerator repair near me in Dubai. Call 043300002 to fix washing machine, fridge, dishwasher, oven";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/appliances-services-in-dubai-hills-estate/";
              ...
              <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                  <div className="container">
                        <h1 className="cs_fs_30">Home Appliance Service in Al Damac Hills Estate</h1>
                    {/* <h2 className="cs_fs_30">CHOOSE APPLIANCE SERVICE CENTER FOR SAME-DAY REPAIRS IN DUBAI Hills Estate</h2> */}
                    <p>
