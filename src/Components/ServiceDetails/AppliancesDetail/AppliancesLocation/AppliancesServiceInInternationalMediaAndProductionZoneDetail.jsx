...
const AppliancesServiceInInternationalMediaAndProductionZoneDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {

  // For SEO
  const metatitle = String(titleSeo || "Best Appliances Services in International Media And Production");
  const metadescription = String(description || "FAJ offers home appliance services in the International Media and Production. Call us fridge, washing machine, dishwasher, cooker & oven repair near you");
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Reliable Home Appliance Repair and Service in International Media and Production Zone Dubai</h1>
            <p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  If you need appliance repair, FAJ is your best choice for fast and affordable service in international Media and Production Zone Dubai and Sharjah.
              ...
              <div className="col-md-6 ">
                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Washing machine repair in International Media and Production Zone" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in International Media and Production Zone" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
...
export default AppliancesServiceInInternationalMediaAndProductionZoneDetail
