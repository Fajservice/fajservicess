...
const AppliancesServiceInLimestoneHouseDifcDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Appliances Services in The Limestone House DIFC Near Me";
  const description = "Get appliances services in the Limestone house DIFC. Looking for refrigerator, fridge, washing machine repair and oven fix near me than call at 043300002";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/appliances-services-in-the-limestone-house-difc";
