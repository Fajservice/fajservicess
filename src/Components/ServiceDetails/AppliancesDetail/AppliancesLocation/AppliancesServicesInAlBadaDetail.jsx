...
const AppliancesServicesInAlBadaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Al Bada - Refrigerator Repair Dubai";
    const description = "Same-day appliance service in Al Bada. Get refrigerator repair near me in Dubai. Call 043300002 to fix washing machine, dishwasher, fridge, and oven.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-al-bada/";
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                            <h1 className="cs_fs_30">Home Appliance Service in Al Bada</h1>
