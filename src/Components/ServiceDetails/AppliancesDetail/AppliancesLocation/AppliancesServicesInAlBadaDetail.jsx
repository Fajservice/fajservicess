...
const AppliancesServicesInAlBadaDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
    ...
    // For SEO
    const metatitle = String(titleSeo || "Best Home Appliances Service and Refrigerator Repair in Al Bada");
    const metadescription = String(description || "Same-day home appliance service in Al Bada. Get refrigerator repair nearby in Dubai. Call 043300002 to fix your washing machine, dishwasher, and oven");
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h1 className="cs_fs_30">Cost-Effective Home Appliances Repair and Fix Service in Al Bada, Dubai</h1>
                        <p>
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2">
                                    If you need appliance repair, FAJ is your best choice for fast and affordable service in Al Bada Dubai and Sharjah.
                            ...
                            <div className="col-md-6 ">
                                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Washing machine repair in Al Bada" />
                            </div>
                        </div>
                ...
                <section className="section cs_py_30 ">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in Al Bada" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
...
export default AppliancesServicesInAlBadaDetail
