...
const AppliancesServicesInAlBadaaDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Al Badaa - Washing Machine Repair";
    const description = "We offer best appliance services in Al Badaa. Get fridge repair near me in Dubai. Book 043300002 for oven, dishwasher, washing machine maintenance";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-al-badaa/";
                ...
                <div className="cs_service_details">
                    ...
                    <section className="section cs_py_30">
                        <div className="container">
                            <h1 className="cs_fs_30">Appliances Services In AlBadaa</h1>
