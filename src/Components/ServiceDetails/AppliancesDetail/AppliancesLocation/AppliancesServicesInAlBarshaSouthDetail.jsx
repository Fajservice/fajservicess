...
const AppliancesServicesInAlBarshaSouthDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Al Barsha South - Fridge Repair";
    const description = "Looking for appliance service in Al Barsha South. Get fridge repair near me in Dubai. Call 043300002 to fix washing machine, dishwasher, refrigerator";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-al-barsha-south/";
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h1 className="cs_fs_30">Appliances Services In AlBarsha South</h1>
