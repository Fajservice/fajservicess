...
const AppliancesServicesInAlSufouhDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Al Sufouh -  Fridge Repair Near Me";
    const description = "Best appliance services in Al Sufouh. FAJ specializes in fridge repair near me in Dubai. Call 043300002 for reliable washing machine & oven fix ";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-al-sufouh";
                                             ...
                                             <div className="container">
                                                 <div className="row gx-md-5">
                                                     <div className="col-md-6">
                                                         ...
                                                         <p className="mb-2">
                                                             If you need appliance repair, FAJ is your best choice for fast and affordable service in Al Sufouh Dubai and Sharjah.
...
export default AppliancesServicesInAlSufouhDetail
