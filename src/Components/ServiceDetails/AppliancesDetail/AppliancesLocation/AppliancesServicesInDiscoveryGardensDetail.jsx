...
const AppliancesServicesInDiscoveryGardensDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Discovery Gardens - Fridge Repair";
    const description = "Best Appliance Services in Discovery Gardens. Get refrigerator repair near me in Dubai. Call 043300002 to fix your washing machine, dishwasher & stove";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-discovery-gardens/";
