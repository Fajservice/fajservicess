...
const AppliancesServicesInDubaiHealthcareCityDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {

    // For SEO
    const metatitle = String(titleSeo || "Expert Appliances Service & Fridge Repair in Dubai Healthcare City");
    const metadescription = String(description || "We provide affordable home appliance services in Dubai Healthcare City. Get your fridge, oven, dishwasher, & washing machine repair near you");
    ...
    const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/coverage-area/dubai-healthcare-city/");
            ...
            <div className="cs_service_details">
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        <h1 className="cs_fs_30">Affordable Home Appliances Repair and Services in Dubai Healthcare City</h1>
                        <p>
                    ...
                    <div className="container">
                        <div className="row gx-md-5">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2">
                                    If you need appliance repair, FAJ is your best choice for fast and affordable service in Dubai Healthcare City  and Sharjah.
                            ...
                            <div className="col-md-6 ">
                                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Washing machine repair in Dubai Healthcare City" />
                            </div>
                        </div>
                ...
                <section className="section cs_py_30">
                    <div className="container">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in Dubai Healthcare City" />
                            </div>
                            <div className="col-md-6">
                                <ul className="mb-0">
...
export default AppliancesServicesInDubaiHealthcareCityDetail
