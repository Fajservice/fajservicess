...
const AppliancesServicesInDubailandMazayaDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {
  ...
  // For SEO
  const metatitle = String(titleSeo || "Best Appliances Services and Fridge Repair in Dubailand Mazaya");
  const metadescription = String(description || "Trusted home appliances service in Dubailand Mazaya. FAJ Experts offer refrigerator, washing machine, cooker, and oven repair near your location");
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/coverage-area/dubailand-mazaya/");
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Cost-Effective Home Appliances Service and Repair in Dubai Land Mazaya</h1>
            <p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  If you need appliance repair, FAJ is your best choice for fast and affordable service in Dubailand Mazaya Dubai and Sharjah.
              ...
              <div className="col-md-6 ">
                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Washing machine repair in Dubailand Mazaya" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in Dubailand Mazaya" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
...
export default AppliancesServicesInDubailandMazayaDetail
