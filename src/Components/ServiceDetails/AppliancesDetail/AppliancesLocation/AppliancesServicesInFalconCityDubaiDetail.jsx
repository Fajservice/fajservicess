...
const AppliancesServicesInFalconCityDubaiDetail = ({ subtitle, title, bgImg }) => {
  ...
  // For SEO
  const titleSeo = "Appliances Services in Falcon City - Washing Machine Repair";
  const description = "We offer best appliance services in Falcon City. Get washing machine repair near me in Dubai. Book 043300002 for fridge, oven, dishwasher maintenance";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/appliances-services-in-falcon-city-dubai/";
