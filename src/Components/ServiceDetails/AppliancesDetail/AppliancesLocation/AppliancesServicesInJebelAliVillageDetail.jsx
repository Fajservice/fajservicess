...
const AppliancesServicesInJebelAliVillageDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL, Image }) => {

  // For SEO
  const metatitle = String(titleSeo || "Affordable Appliances Services & Fridge Repair in Jebel Ali Village");
  const metadescription = String(description || "Top-rated home appliance service in Jebel Ali Village, Dubai. Contact us for dishwasher, washing machine, dryer, fridge, cooker, & oven repair near you");
  ...
  const metaURL = String(URL || "https://www.fajservices.ae/services/home-appliances-repair/coverage-area/jebel-ali-village/");
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Top-Rated Home Appliances Repair and Services in Jebel Ali Village, Dubai</h1>
            <p>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  If you need appliance repair, FAJ is your best choice for fast and affordable service in Jebel Ali Village Dubai and Sharjah.
              ...
              <div className="col-md-6 ">
                <img className="bordered-img w-100" src={getImageSrc('The-Most-Common-Reasons-for-Appliance-Breakdowns')}  alt="Washing machine repair in Jebel Ali Village" />
              </div>
            </div>
        ...
        <section className="section cs_py_30">
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={getImageSrc('dishwasher-repair-service')}  alt="Refrigerator Repair in Jebel Ali Village" />
              </div>
              <div className="col-md-6">
                <ul className="mb-0">
