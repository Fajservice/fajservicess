...
const AppliancesServicesInJumeirahDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Jumeirah - Washing Machine Repair";
    const description = "Looking for appliances Service in Jumeirah. FAJ provides refrigerator, fridge repair dubai, washing machine maintenance & more. Call now 043300002";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-jumeirah/";
