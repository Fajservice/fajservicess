...
const AppliancesServicesInJumeirahIslandsDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metaKeyword = String(Keyword || "Washing Machine & Fridge Repair in Jumeirah Islands Dubai – Home Appliance Installation, Maintenance & Service Centre in Jumeirah Islands Dubai");
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Appliances Services In JumeirahIslandsi</h1>
