...
const AppliancesServicesInSiliconOasisDubaiDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Appliances Services in Silicon Oasis Dubai - Fridge Repair";
  const description = "FAJ offers appliances services in Silicon Oasis Dubai. Get refrigerator, fridge, washing machine repair and oven fix near me. Contact now 043300002.";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/appliances-services-in-silicon-oasis-dubai/";
