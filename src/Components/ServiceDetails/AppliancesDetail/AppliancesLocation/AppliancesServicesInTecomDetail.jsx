...
const AppliancesServicesInTecomDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Appliances Services in Tecom - Washing Machine Repair Dubai";
    const description = "We offer appliances services in Tecom Dubai. Do you need refrigerator, washing machine, fridge repair near me. Call at 043300002 to get quick services.";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-tecom/";
