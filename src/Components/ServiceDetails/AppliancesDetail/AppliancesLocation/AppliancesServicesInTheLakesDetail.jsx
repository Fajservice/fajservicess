...
const AppliancesServicesInTheLakesDetail = ({ subtitle, title, bgImg }) => {


    // For SEO
    const titleSeo = "Best Appliances Services in The Lakes - Refrigerator Repair";
    const description = "Looking for appliances services in The Lakes. Call us now at 043300002 to get fridge, washing machine, refrigerator repair near me in Dubai. ";
    const Author = "Faj Technical Servcies";
    const Keyword = "";
    const URL = "https://www.fajservices.ae/appliances-services-in-the-lakes/";
...
export default AppliancesServicesInTheLakesDetail
