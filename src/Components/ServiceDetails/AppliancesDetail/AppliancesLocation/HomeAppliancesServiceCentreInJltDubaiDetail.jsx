...
const HomeAppliancesServiceCentreInJltDubaiDetail = ({ subtitle, title, bgImg }) => {

  // For SEO
  const titleSeo = "Home Appliances Service in JLT - Refrigerator Repair Dubai";
  const description = "FAJ offers home appliances service in JLT, Dail 043300002 for Electrolux, LG, Daewoo, Bosch, Teka fridge, washing machine, oven, dishwasher repair";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/home-appliances-installation-maintenance-repair-fix-service-centre-in-jlt-dubai/";
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Home Appliances Service Centre In JltDubai</h1>
...
export default HomeAppliancesServiceCentreInJltDubaiDetail
