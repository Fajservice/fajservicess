...
const WashingMachineRepairBusinessBayDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Washing Machine Repair Business Bay - Refrigerator Service";
  const description = "FAJ washing machine repair business bay. Get same day Bosch, Electrolux, Siemens, Teka, Daewoo refrigerator, dryer, dishwasher, oven service near me";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/washing-machine-repair-business-bay-fridge-repair-business-bay-refrigerator-repairing-business-bay-cooker-stove-oven-cooking-range-repairs-fix-service-centre-business-bay-dishwasher-installation-fixin/";
...
export default WashingMachineRepairBusinessBayDetail
