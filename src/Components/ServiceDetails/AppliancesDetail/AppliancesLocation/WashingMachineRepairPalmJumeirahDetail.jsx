...
const WashingMachineRepairPalmJumeirahDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Washing Machine Repair Palm Jumeirah - Fridge Service Dubai";
  const description = "FAJ washing machine repair in Palm Jumeirah. Get same day Bosch, LG, Siemens, Teka, Samsung refrigerator dryer, dishwasher, oven, service near you";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/washing-machine-repair-palm-jumeirah-fridge-repair-palm-jumeirah-refrigerator-repairing-palm-jumeirah-cooker-stove-oven-cooking-range-repairs-fix-service-centre-palm-jumeirah-dishwasher-installation-f/";
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  If you need appliance repair, FAJ is your best choice for fast and affordable service in Palm Jumeirah Dubai and Sharjah.
...
export default WashingMachineRepairPalmJumeirahDetail
