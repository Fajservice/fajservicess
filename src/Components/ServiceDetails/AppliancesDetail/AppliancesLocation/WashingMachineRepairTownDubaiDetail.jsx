...
const WashingMachineRepairTownDubaiDetail = ({ subtitle, title, bgImg }) => {


  // For SEO
  const titleSeo = "Washing Machine Repair Town Dubai - Refrigerator Service";
  const description = "Get same day washing machine repair in Town Dubai. FAJ offers Bosch, LG, Siemens, Samsung refrigerator dryer, dishwasher, oven service near me ";
  const Author = "Faj Technical Servcies";
  const Keyword = "";
  const URL = "https://www.fajservices.ae/washing-machine-repair-town-dubai-fridge-repair-town-dubai-refrigerator-repairing-town-dubai-cooker-stove-oven-cooking-range-repairs-fix-service-centre-town-dubai-dishwasher-installation-fixing-mainte/";
      ...
      <div className="cs_service_details">
        <section className="section cs_py_30">
          <div className="container">
            <h1 className="cs_fs_30">Washing Machine Repair in TownDubai</h1>
          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  If you need appliance repair, FAJ is your best choice for fast and affordable service in Town Dubai and Sharjah.
...
export default WashingMachineRepairTownDubaiDetail
