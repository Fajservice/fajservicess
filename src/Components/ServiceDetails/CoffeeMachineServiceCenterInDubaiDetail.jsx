...
const CoffeeMachineServiceCenterInDubaiDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  // For SEO
  const metatitle = String(titleSeo || "Coffee Machine Service Center Dubai | 24/7 Maintenance Service");
  const metadescription = String(description || "Best FAJ Coffee machine service center in Dubai. Call 043300002 for home /office espresso machine & restaurant's coffee maker repair and maintenance.");
