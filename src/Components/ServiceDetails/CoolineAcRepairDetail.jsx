...
import data from '../../Data/AcData/AcFaqs/CoolineAcRepairfaq.json';
...
import MaintenanceContract from "../MaintenanceContract/MaintenanceContract";import testimonial_data_Cooline from '../../Data/AcData/AcFaqs/AcTestimonial/CoolineAcServiceTestimonials.json';
...
const CoolineAcRepair = ({ subtitle, title, bgImg }) => {
  ...
  return (
    <>
      <HelmetProvider>
      <title>Best Cooline AC Repair In Dubai - Air Conditioner Service</title>
      <meta name="description" content="Get emergency Cooline AC repair in Dubai by FAJ Co, We are experts in HVAC, central air conditioning maintenance service near you Dubai UAE"/>
      </HelmetProvider>
            ...
            <div className="container">
                <div className="row g-5">
                    <div className="col-md-6">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}/img/reem-ac-service.jpg`} alt="Cooline Ac Repair" />
                        <h3 className="cs_fs_25 mb-1 mt-3">Best Cooline AC Repair in Dubai</h3>
                        <p>When it comes to Cooline <Link to="/ac-repair-dubai/"><b>AC repair</b></Link>  in Dubai, it’s essential to hire a professional and trustworthy <Link to="/ac-maintenance-dubai/"><b>AC technician</b></Link> for your home or office.</p>
                    ...
                    <div className="col-md-6 border-small-left">
                        <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}/img/indoor-ac-servicing.jpg`} alt="Cooline Ac Repair" />
          ...
          <h3 className="cs_fs_30">Cooline Air Con Service Quality Workmanship </h3>
            <div className="row align-items-center">
              <div className="col-md-6">
                ...
                <h3 className="cs_fs_24">Problems That Commonly Arise With Your HVAC & Split Ac</h3>
                <ul className="d-flex flex-wrap column-gap-4">
                    <li>Damaged Compressor</li>
                    <li>Ac is stinking</li>
                    <li>The thermostat is not doing its job</li>
                    <li>Air con refrigerant frequently leak</li>
                    <li>Dirty Aircon filter </li>
                    <li>Indoor and outdoor water leaking because of clogged coils</li>
                    <li>Circuit breaker tripping</li>
                    <li>Thermostat malfunction</li>
                    <li>Capacitor failed to do its function</li>
                    <li>The air conditioner  making an unusual noise</li>
                    <li>Ductwork is leaking</li>
                    <li>Evaporator coils are frozen</li>
                    <li>Weak flow of cool air</li>
                    <li>Ac fan failure</li>
                </ul>
              </div>
              <div className="col-md-6 text-center text-md-end">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}/img/daikin-ac-service.jpg`} alt="Cooline Ac Repair" />
        ...
        <section className="section cs_py_30">
          ...
          <h3 className="cs_fs_30">Get A Full Fledged Expert Service Of Cooline HVAC</h3>
            ...
            <div className="col-xl-6">
                ...
                <div className="col-xl-6">
                  <img className="blue-border" src={`${import.meta.env.BASE_URL}/img/Midea-ac-repair.jpg`} alt="Cooline Ac Repair" />
                </div>
