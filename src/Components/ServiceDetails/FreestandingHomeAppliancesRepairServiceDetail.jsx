...
import data from '../../Data/FreestandingHomeAppliancesRepairService.json';
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_48">
          <div className="container">
            ...
            <h2 className="cs_fs_30">CHOOSE APPLIANCE SERVICE CENTRE FOR SAME-DAY REPAIRS IN DUBAI</h2>
            <p>
        ...
        <section className="section cs_py_48 bg-light-gray">
          <div className="container">
            ...
            <p>
              Let's face it, modern life revolves around our appliances. From the refrigerator that keeps our food fresh to the washing machine that handles the endless piles of laundry, these gadgets are indispensable. But what happens when they break down? It's not just an inconvenience; it can throw a wrench in our entire routine.
            </p>
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <ul className="mb-0">
                  ...
                  <li> <strong> Dishwashers Common Issues: </strong> They may have problems with draining, leading to water pooling at the bottom, or  they might not clean dishes effectively. </li>

                  <li> <strong> Ovens and Stoves Common Issues: </strong> Ovens and stoves often face problems with heating elements or ignition. This  can result in the oven not heating up properly or the stove failing to ignite. </li>
          ...
          <div className="container">
            ...
            <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_18 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Refrigerator Problem</h3>
                  </div>
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_18 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Dishwashers Problem</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_18 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Washing Machine Problem
                    </h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  <div className="text-center">
                    <h3 className="cs_fs_18 mb-0 bg-dark-blue rounded-top text-light py-2 py-md-1">Tumble Dryer Problem</h3>
                  </div>
                  <div className="inner-apcs-feat-desc">
        ...
        <section className="section cs_py_48 bg-light-gray">
          <div className="container">
            <h3 className="cs_fs_30">Appliances We Repair</h3>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                ...
                <p>Our specialty is fixing common household appliances like dishwashers, ovens, dryers, washing machines, and refrigerators. </p>
                <p>
                  These appliances are crucial to your daily life, and our experienced technicians quickly diagnose and fix any issues. Your convenience and satisfaction are our top priorities!</p>
                <p>
                  Our experts strive to provide same-day and next-day appliance repair services to homes in Dubai.
                  You’ll always know the cost upfront with quotes from F A J. </p>
                <p>
                  We offer quality repair services for all home and kitchen appliances.
                </p>
          ...
          <div className="container container-md container-sm">
            ...
            <div className="usps align-items-center	">
              ...
              <div className="uspdelimit col-2 d-none d-xl-block">
                <img className="blue-border-2 w-100" src={`${import.meta.env.BASE_URL}/img/fajteam-1.jpg`} alt="FAJ icon service" />
              </div>
