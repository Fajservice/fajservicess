    ...
    return (
        <>
            ...
            <div className="cs_service_details">
                ...
                {/* Our Appliance Repair Dubai Service includes */}

                <section className="section cs_py_48 bg-light-gray">
                    <div className="container">
                        <h3 className="cs_fs_30">Our Appliance Repair Dubai Service includes</h3>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-6">
                                ...
                                <p>FAJ has been offering washing machine repair services in Dubai for the past 13 years. We are a group of trained professionals who specialize in major brand washer repair. We can repair any spinning, clogging, draining, pipe leaking, broken pipe, motor, or other issue. Our highly trained specialists will promptly repair your broken washer so you can go back to doing your laundry.</p>
