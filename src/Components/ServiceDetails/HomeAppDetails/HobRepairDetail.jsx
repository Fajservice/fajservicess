          ...
          <div className="container">
            <div className="row gx-md-5">
              <div className="col-md-6">
                {/* <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/reem-ac-service.avif`} alt="Hob Repair Servcie" /> */}
                ...
                <h3 className="cs_fs_20 mb-1 pt-3 border-small-top">EXPRESS & EMERGENCY Hob REPAIR SERVICE</h3>
...
and <small>3-month parts warranty</small> as standard.</p>
              ...
              <div className="col-md-6 ">
                {/* <img className="bordered-img w-100" src={`${import.meta.env.BASE_URL}img/indoor-ac-servicing.avif`} alt="Hob Repair Servcie" /> */}
