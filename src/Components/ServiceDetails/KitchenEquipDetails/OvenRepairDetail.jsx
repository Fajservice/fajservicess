              ...
              <div className="row gx-3 gy-5 mt-0">
                  ...
                  <div>
                    <div className="benifit-box-container">
                      <div className="icon-img-block">
                        <img src={getImageSrc('icon/HEATINGEFFICIENCY-New')} alt="Cooling Efficiency" className="icon-img-block-icon" />
                      </div>
                ...
                <div className="col-md-4 mb-2">
                  <div>
                    <div className="benifit-box-container">
                      <div className="icon-img-block">
                        <img src={getImageSrc('icon/DISINFECTCOMPONENTS-New')} alt="Cooling Efficiency" className="icon-img-block-icon" />
                      </div>
