...
const IceMakerRepairDetail = ({ subtitle, title, reviewsbg, titleSeo, description, Author, Keyword, URL }) => {
  ...
  const metadescription = String(description || "Reliable ice maker's repair in Dubai. We specialise in hoshizaki, manitowoc, generaltec. brema, scotsman ice cube machine's maintenance & AMC service.");
