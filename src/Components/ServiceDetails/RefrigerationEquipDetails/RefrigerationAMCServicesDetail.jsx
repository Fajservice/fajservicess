  ...
  return (
    <>
      ...
      <div className="cs_service_details">
        ...
        <section className="section cs_py_30">
          <div className="container">
            <h3 className="cs_fs_30">Peace of Mind with Maintenance Contract of Refrigeration</h3>
            <p>
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <img className="blue-border" src={`${import.meta.env.BASE_URL}img/techfridge.avif`} alt="Oven Repair" />
              </div>
              <div className="col-md-6">
                <p className="mb-0">
            ...
            <div className="row gx-2 gx-lg-3 gy-3 gy-lg-4 justify-content-center">
              ...
              <div className="col-12 col-md-4 col-lg-3">
                <div className=" box-content-container rounded border shadow">
                  ...
                  <div className="inner-apcs-feat-desc">
                    <p className="p-2 mb-0">
                      Worn or cracked door gaskets can cause cool air to escape, forcing the system to work harder and compromising temperature control.
                    </p>
                  </div>
                </div>
              </div>
