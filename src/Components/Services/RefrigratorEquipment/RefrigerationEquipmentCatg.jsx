...
const RefrigerationEquipmentCatg = ({ subtitle, title, reviewsbg, titleSeo, description, Author, URL, Image }) => {
    ...
    <>
      <HelmetProvider>
        <Helmet>
          ...
          <meta name="twitter:title" content="Refrigeration equipment Repair Service in Dubai - FAJ Technical Services L.L.C" />
          <meta name="twitter:description" content="Refrigeration equipment Repair and Maintenance Services in Dubai" />
...
export default RefrigerationEquipmentCatg