...
const BlombergFridgeRepair = () => {
  return (
    ...
    <BreadCumb
        bgImg="img/banners/homeappliancesbrands/desktop/Blomberg-Fridge-Repair-faj.avif"
        mobileBgImg="img/banners/homeappliancesbrands/mobile/Blomberg-Fridge-Repair-faj.avif"
