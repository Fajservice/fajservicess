...
const WhirlpoolFridgeRepair = () => {
  return (
    ...
    <BreadCumb
        bgImg="img/banners/homeappliancesbrands/desktop/whirlpool-fridge-repair-faj.avif"
        mobileBgImg="img/banners/homeappliancesbrands/mobile/whirlpool-fridge-repair-faj.avif"
