  ...
  return (
    <div className="serviceDetails">
            <BreadCumb
                ...
                Title="Home Appliance Service in Jebel Ali Industrial Area">
            </BreadCumb>
            <ApplianceServiceInJebelAliIndustrialAreaDetail/>
    </div>
  )
}

export default ApplianceServiceInJebelAliIndustrialArea
