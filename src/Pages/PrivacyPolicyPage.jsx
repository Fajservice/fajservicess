                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-12 cs_fs_12">
                            ...
                            <p className="my-2"><strong>UAE:</strong> Warehouse No - S-02 Gate 35 Street 18B - Al Quoz - Al Quoz Industrial Area 4 - Dubai - United Arab Emirates</p>
                            ...
                            <li>We need to investigate, prevent, or take action regarding unlawful activities, suspected fraud, potential threats to safety or security, violations of FAJ Technical Services LLC terms of use, or to defend against legal claims.</li>
                            ...
                            <li>Information related to any transactions carried out between you and us through this website, including details of any purchases you make of our goods or services (such as booking health and wellness services through FAJ Technical Services LLC).</li>
