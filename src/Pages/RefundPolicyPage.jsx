                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-12 cs_fs_12">
                            ...
                            <p className="my-2">All services are deemed complete and satisfactory unless <strong>FAJ Technical Services L.L.C </strong>receives written notice within 24 hours of service completion.</p>
                            ...
                            <p className="my-2"><strong>FAJ Technical Services L.L.C</strong> limits its liability for damages, losses, or issues related to its services to the cost of the service provided. Under no circumstances will the liability exceed the total amount paid for the service.</p>
                            <p><strong>Third-Party Insurance Coverage:</strong></p>
                            <p className="my-2">Where applicable, third-party insurance may provide additional coverage for damages that exceed the internal liability limit of <strong>FAJ Technical Services L.L.C</strong>. In the event of accidental damage or negligence by company personnel, FAJ Technical Services L.L.C will assist with the claims process with the insurance provider to cover any additional damages, subject to the terms and conditions of the insurance policy. However, any claim for damages through third-party insurance must be approved by the insurance company and is subject to their limits. FAJ Technical Services L.L.C does not guarantee full approval of any claims made under this coverage.</p>
                            ...
                            <p className="my-2">If damages or issues arise due to negligence by <strong>FAJ Technical Services L.L.C</strong> or its staff, we will cover damages up to a maximum of 100% of the job price. If the damages exceed this amount, third-party insurance (where applicable) may provide additional coverage as specified in the insurance policy. The total liability, including any insurance coverage, will not exceed either the job price or the insurance limit, whichever is higher. However, we cannot guarantee the full approval of any claims under this coverage.</p>
                            <ul className="mb-3">
