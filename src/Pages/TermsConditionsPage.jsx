                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-12 cs_fs_12">
                            ...
                            <p><strong>FAJ Technical Services LLC</strong> limits its liability for damages, losses, or issues related to its services to the cost of the service provided. Under no circumstances will the liability exceed the total amount paid for the service.</p>
                            <p><strong>Third-Party Insurance Coverage:</strong></p>
                            <p>Where applicable, third-party insurance may provide additional coverage for damages that exceed the internal liability limit of <strong>FAJ Technical Services LLC</strong>. In the event of accidental damage or negligence by company personnel, FAJ Technical Services LLC will assist with the claims process with the insurance provider to cover any additional damages, subject to the terms and conditions of the insurance policy. However, any claim for damages through third-party insurance must be approved by the insurance company and is subject to their limits. FAJ Technical Services LLC does not guarantee full approval of any claims made under this coverage.</p>
                            ...
                            <p>If damages or issues arise due to negligence by <strong>FAJ Technical Services LLC</strong> or its staff, we will cover damages up to a maximum of 100% of the job price. If the damages exceed this amount, third-party insurance (where applicable) may provide additional coverage as specified in the insurance policy. The total liability, including any insurance coverage, will not exceed either the job price or the insurance limit, whichever is higher. However, we cannot guarantee the full approval of any claims under this coverage.</p>
                            ...
                            <ul>
                                ...
                                <li>FAJ Technical Services LLC reserves the right to edit, revise, amend, or change any or all Terms and Conditions of use without prior notice to users. You are required to review this document before using the website each time you sign in or browse through it.</li>
                                ...
                                <li>We may provide links to third-party websites on our site for your reference. Please note that these hyperlinks are not operated by FAJ Technical Services LLC and do not constitute part of our website or any agreement. FAJ Technical Services LLC is not responsible for the accuracy of the content on these external websites.</li>
                                ...
                                <li>All content and materials on this website are the property of FAJ Technical Services LLC, and reproduction is not permitted. By using this website, you agree not to engage in any unauthorised use of the information provided.</li>

                                <li>The Terms and Conditions clearly state that you do not have any partnership or authority over FAJ Technical Services LLC. We want to assure you that we will not be held responsible for any difficulties we may encounter in fulfilling our obligations due to factors beyond our control. This includes, but is not limited to, electronic, mechanical, or communication failures or degradations.</li>

                                <li>All materials on this website are owned by or licensed to FAJ Technical Services LLC. This includes, but is not limited to, the layout, design, appearance, graphics, and other content. Reproduction of these materials is strictly prohibited, except as permitted under the copyright notice, which is part of these terms and conditions.</li>
                                ...
                                <li>When you book a service through FAJ Technical Services LLC, we will assist you in arranging premium home services. Please note that once you request any of our home and personal wellness services, the fees you pay to our company are non-refundable, unless there is a violation caused by the company.</li>
                                ...
                                <li>FAJ Technical Services LLC may adjust rates and fees periodically by posting the changes on the FAJ website. No advance notice is required for temporary promotions or for any changes that lead to a reduction in rates and fees.</li>

                                <li>FAJ Technical Services LLC conducts background checks on its team members both directly and through third-party services. However, we encourage each user to use common sense and caution to protect their safety and property, just as you would when interacting with any unfamiliar person.</li>

                                <li>The users agree to release FAJ Technical Services LLC from any liability for damages and/or missing items that may occur during or after using our home services through FAJ.</li>

                                <li>FAJ Technical Services LLC will process payments for your confirmed bookings using the payment method you selected on our website, such as a credit card or cash. If you choose to pay with a credit card, we may request pre-authorisation of your credit card account prior to completing your purchase.</li>
                                ...
                                <li>FAJ Technical Services LLC is not responsible for any damage to your property that may occur while entering or exiting the house. Additionally, the FAJ Technical Services LLC team is not obligated to cover any damages caused during the cleaning session.</li>

                                <li>If any provision of these Terms and Conditions is found to be unenforceable or invalid, that provision will be limited to the minimum extent necessary to ensure that the remainder of the Terms and Conditions remains in full force and effect. FAJ Technical Services LLC may transfer, assign, or delegate these Terms and Conditions, along with its rights and obligations, without requiring consent.</li>

                                <li>FAJ Technical Services LLC will not engage in trade or provide services to countries sanctioned by OFAC.</li>

                                <li>FAJ Technical Services LLC will communicate via WhatsApp, SMS, email, or notifications for purposes including but not limited to appointment confirmations, updates, and marketing.</li>

                                <li>FAJ Technical Services LLC is a booking platform that provides a variety of premium technical services. These services include, but are not limited to, air conditioning services, refrigeration system maintenance, laundry appliance maintenance, large and small appliance repairs, coffee machine servicing, and other technical services. FAJ Technical Services LLC partners with third-party service providers who are licensed by the relevant authorities.</li>

                                <li>FAJ Technical Services LLC strongly advises that a customer representative be on the property during all services. Please do not leave front door keys under doormats or in unattended areas.</li>

                                <li>FAJ Technical Services LLC's technical team needs access to water and electricity to carry out the work, if required. Otherwise, we may not be able to proceed..</li>

                                <li>All permits, gate passes, and other necessary documentation must be arranged by the customer prior to the appointment to avoid any delays. If FAJ Technical Services LLC is unable to gain access to complete the service after three attempts, the assigned services will be forfeited.</li>
